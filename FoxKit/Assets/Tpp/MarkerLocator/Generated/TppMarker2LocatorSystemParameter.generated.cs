...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppMarkerLocator/TppMarker2LocatorSystemParameter")]
	public partial class TppMarker2LocatorSystemParameter : Fox.Core.DataElement
	{
		...
		static TppMarker2LocatorSystemParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppMarker2LocatorSystemParameter", typeof(TppMarker2LocatorSystemParameter), Fox.Core.DataElement.ClassInfo, 28, null, 0);
