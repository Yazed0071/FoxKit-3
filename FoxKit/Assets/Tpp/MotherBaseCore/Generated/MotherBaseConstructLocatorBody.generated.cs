...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppMotherBaseCore/MotherBaseConstructLocatorBody")]
	public partial class MotherBaseConstructLocatorBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static MotherBaseConstructLocatorBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("MotherBaseConstructLocatorBody", typeof(MotherBaseConstructLocatorBody), Fox.Core.TransformDataBody.ClassInfo, 0, "TppMotherBase", 0);
