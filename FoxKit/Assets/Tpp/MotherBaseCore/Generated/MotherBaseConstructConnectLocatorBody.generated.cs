...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppMotherBaseCore/MotherBaseConstructConnectLocatorBody")]
	public partial class MotherBaseConstructConnectLocatorBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static MotherBaseConstructConnectLocatorBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("MotherBaseConstructConnectLocatorBody", typeof(MotherBaseConstructConnectLocatorBody), Fox.Core.TransformDataBody.ClassInfo, 0, "TppMotherBase", 0);
