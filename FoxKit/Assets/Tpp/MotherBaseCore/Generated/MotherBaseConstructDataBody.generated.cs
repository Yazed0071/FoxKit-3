...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppMotherBaseCore/MotherBaseConstructDataBody")]
	public partial class MotherBaseConstructDataBody : Fox.Core.TransformDataBody
	{
		...
		static MotherBaseConstructDataBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("MotherBaseConstructDataBody", typeof(MotherBaseConstructDataBody), Fox.Core.TransformDataBody.ClassInfo, 0, "TppMotherBase", 0);
