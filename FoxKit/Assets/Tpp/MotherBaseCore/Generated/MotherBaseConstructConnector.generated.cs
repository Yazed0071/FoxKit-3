...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppMotherBaseCore/MotherBaseConstructConnector")]
	public partial class MotherBaseConstructConnector : Fox.Core.Entity
	{
		// ClassInfos
		...
		static MotherBaseConstructConnector()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("MotherBaseConstructConnector", typeof(MotherBaseConstructConnector), Fox.Core.Entity.ClassInfo, 0, "TppMotherBase", 0);
