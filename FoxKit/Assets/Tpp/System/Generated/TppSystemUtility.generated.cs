...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppSystem/TppSystemUtility")]
	public partial class TppSystemUtility : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppSystemUtility()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppSystemUtility", typeof(TppSystemUtility), Fox.Core.Entity.ClassInfo, 0, null, 0);
