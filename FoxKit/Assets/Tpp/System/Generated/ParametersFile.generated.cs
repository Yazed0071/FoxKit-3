...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppSystem/ParametersFile")]
	public partial class ParametersFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static ParametersFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("ParametersFile", typeof(ParametersFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
