...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppMotherBaseStage/TppMotherBaseStageBlockControllerDataBody")]
	public partial class TppMotherBaseStageBlockControllerDataBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static TppMotherBaseStageBlockControllerDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppMotherBaseStageBlockControllerDataBody", typeof(TppMotherBaseStageBlockControllerDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
