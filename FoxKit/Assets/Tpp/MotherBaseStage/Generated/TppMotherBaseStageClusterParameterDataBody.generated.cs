...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppMotherBaseStage/TppMotherBaseStageClusterParameterDataBody")]
	public partial class TppMotherBaseStageClusterParameterDataBody : Fox.Core.DataBody
	{
		...
		static TppMotherBaseStageClusterParameterDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppMotherBaseStageClusterParameterDataBody", typeof(TppMotherBaseStageClusterParameterDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
