...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppGimmickImmediateStateData")]
	public partial class TppGimmickImmediateStateData : Fox.Core.Data
	{
		...
		static TppGimmickImmediateStateData()
		{
			if (Fox.Core.Data.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppGimmickImmediateStateData", typeof(TppGimmickImmediateStateData), Fox.Core.Data.ClassInfo, 68, "Gimmick", 0);
		...
		public override Fox.Core.Value GetProperty(string propertyName)
		{
			...
			{
				case "numMaxMemory":
					return new Fox.Core.Value(numMaxMemory);
				default:
