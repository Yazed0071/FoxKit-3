...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppTrapCheckIsPlayerCallbackDataElement")]
	public partial class TppTrapCheckIsPlayerCallbackDataElement : Fox.Geo.GeoTrapModuleCallbackDataElement
	{
		// ClassInfos
		...
		static TppTrapCheckIsPlayerCallbackDataElement()
		{
			if (Fox.Geo.GeoTrapModuleCallbackDataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppTrapCheckIsPlayerCallbackDataElement", typeof(TppTrapCheckIsPlayerCallbackDataElement), Fox.Geo.GeoTrapModuleCallbackDataElement.ClassInfo, 32, null, 0);
