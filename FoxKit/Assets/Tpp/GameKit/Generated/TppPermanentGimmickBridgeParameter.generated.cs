...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppPermanentGimmickBridgeParameter")]
	public partial class TppPermanentGimmickBridgeParameter : Fox.Core.DataElement
	{
		...
		static TppPermanentGimmickBridgeParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppPermanentGimmickBridgeParameter", typeof(TppPermanentGimmickBridgeParameter), Fox.Core.DataElement.ClassInfo, 32, null, 0);
