...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteEdgeEventVehicleBackFast")]
	public partial class TppRouteEdgeEventVehicleBackFast : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRouteEdgeEventVehicleBackFast()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteEdgeEventVehicleBackFast", typeof(TppRouteEdgeEventVehicleBackFast), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
