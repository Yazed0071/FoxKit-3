...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppGuardTargetDataBody")]
	public partial class TppGuardTargetDataBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static TppGuardTargetDataBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppGuardTargetDataBody", typeof(TppGuardTargetDataBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
