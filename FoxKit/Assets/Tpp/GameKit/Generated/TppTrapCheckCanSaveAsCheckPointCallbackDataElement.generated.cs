...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppTrapCheckCanSaveAsCheckPointCallbackDataElement")]
	public partial class TppTrapCheckCanSaveAsCheckPointCallbackDataElement : Fox.Geo.GeoTrapModuleCallbackDataElement
	{
		// ClassInfos
		...
		static TppTrapCheckCanSaveAsCheckPointCallbackDataElement()
		{
			if (Fox.Geo.GeoTrapModuleCallbackDataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppTrapCheckCanSaveAsCheckPointCallbackDataElement", typeof(TppTrapCheckCanSaveAsCheckPointCallbackDataElement), Fox.Geo.GeoTrapModuleCallbackDataElement.ClassInfo, 32, null, 0);
