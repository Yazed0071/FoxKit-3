...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppTrapCheckIsInCameraCallbackDataElement")]
	public partial class TppTrapCheckIsInCameraCallbackDataElement : Fox.Geo.GeoTrapModuleCallbackDataElement
	{
		// ClassInfos
		...
		static TppTrapCheckIsInCameraCallbackDataElement()
		{
			if (Fox.Geo.GeoTrapModuleCallbackDataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppTrapCheckIsInCameraCallbackDataElement", typeof(TppTrapCheckIsInCameraCallbackDataElement), Fox.Geo.GeoTrapModuleCallbackDataElement.ClassInfo, 32, null, 1);
