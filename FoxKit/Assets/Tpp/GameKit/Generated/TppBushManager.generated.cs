...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppBushManager")]
	public partial class TppBushManager : Fox.Core.Entity
	{
		...
		public override void RemovePropertyElement(string propertyName, int index)
		{
			...
			{
				case "existMaterials":
					this.existMaterials.RemoveAt(index);
					return;
				case "noiseSeType":
					this.noiseSeType.RemoveAt(index);
					return;
				default:
		...
		public override void RemovePropertyElement(string propertyName, string key)
		{
			...
			{
				case "noiseSeEventNames":
					this.noiseSeEventNames.Remove(key);
					return;
				default:
