...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppCombatLocatorSetDataBody")]
	public partial class TppCombatLocatorSetDataBody : Fox.Core.DataBody
	{
		...
		static TppCombatLocatorSetDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppCombatLocatorSetDataBody", typeof(TppCombatLocatorSetDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
