...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteNodeEventPutHostageInVehicle")]
	public partial class TppRouteNodeEventPutHostageInVehicle : Fox.GameService.GsRouteDataNodeEvent
	{
		// Properties
		...
		static TppRouteNodeEventPutHostageInVehicle()
		{
			if (Fox.GameService.GsRouteDataNodeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteNodeEventPutHostageInVehicle", typeof(TppRouteNodeEventPutHostageInVehicle), Fox.GameService.GsRouteDataNodeEvent.ClassInfo, 0, null, 0);
