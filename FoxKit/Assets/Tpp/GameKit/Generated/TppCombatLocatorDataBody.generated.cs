...
namespace Tpp.GameKit
{
	...
	public partial class TppCombatLocatorDataBody : Fox.Core.TransformDataBody
	{
		...
		static TppCombatLocatorDataBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppCombatLocatorDataBody", typeof(TppCombatLocatorDataBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
