...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/CoverPointFile")]
	public partial class CoverPointFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static CoverPointFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("CoverPointFile", typeof(CoverPointFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
