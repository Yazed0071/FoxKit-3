...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppCyprusBlockControl")]
	public partial class TppCyprusBlockControl : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppCyprusBlockControl()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppCyprusBlockControl", typeof(TppCyprusBlockControl), Fox.Core.Entity.ClassInfo, 0, null, 0);
