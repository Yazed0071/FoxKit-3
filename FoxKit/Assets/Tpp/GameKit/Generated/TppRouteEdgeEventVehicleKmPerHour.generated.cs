...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteEdgeEventVehicleKmPerHour")]
	public partial class TppRouteEdgeEventVehicleKmPerHour : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRouteEdgeEventVehicleKmPerHour()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteEdgeEventVehicleKmPerHour", typeof(TppRouteEdgeEventVehicleKmPerHour), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
