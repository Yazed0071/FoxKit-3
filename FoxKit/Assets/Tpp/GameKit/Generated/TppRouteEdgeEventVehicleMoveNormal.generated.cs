...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteEdgeEventVehicleMoveNormal")]
	public partial class TppRouteEdgeEventVehicleMoveNormal : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRouteEdgeEventVehicleMoveNormal()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteEdgeEventVehicleMoveNormal", typeof(TppRouteEdgeEventVehicleMoveNormal), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
