...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppCoverPointBody")]
	public partial class TppCoverPointBody : Fox.Tactical.GkTacticalPointBody
	{
		// ClassInfos
		...
		{
			if (Fox.Tactical.GkTacticalPointBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppCoverPointBody", typeof(TppCoverPointBody), Fox.Tactical.GkTacticalPointBody.ClassInfo, 0, null, 0);
