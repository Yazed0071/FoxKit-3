...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppCoverPointProvider")]
	public partial class TppCoverPointProvider : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppCoverPointProvider()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppCoverPointProvider", typeof(TppCoverPointProvider), Fox.Core.Entity.ClassInfo, 0, null, 0);
