...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppTrapCheckIsPlayerAliveCallbackDataElement")]
	public partial class TppTrapCheckIsPlayerAliveCallbackDataElement : Fox.Geo.GeoTrapModuleCallbackDataElement
	{
		// ClassInfos
		...
		static TppTrapCheckIsPlayerAliveCallbackDataElement()
		{
			if (Fox.Geo.GeoTrapModuleCallbackDataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppTrapCheckIsPlayerAliveCallbackDataElement", typeof(TppTrapCheckIsPlayerAliveCallbackDataElement), Fox.Geo.GeoTrapModuleCallbackDataElement.ClassInfo, 0, null, 0);
