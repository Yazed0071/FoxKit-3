...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppLadderDataBody")]
	public partial class TppLadderDataBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static TppLadderDataBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppLadderDataBody", typeof(TppLadderDataBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
