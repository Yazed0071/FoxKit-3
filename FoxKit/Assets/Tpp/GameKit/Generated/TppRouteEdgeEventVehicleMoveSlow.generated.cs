...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/TppRouteEdgeEventVehicleMoveSlow")]
	public partial class TppRouteEdgeEventVehicleMoveSlow : Fox.GameService.GsRouteDataEdgeEvent
	{
		// Properties
		...
		static TppRouteEdgeEventVehicleMoveSlow()
		{
			if (Fox.GameService.GsRouteDataEdgeEvent.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRouteEdgeEventVehicleMoveSlow", typeof(TppRouteEdgeEventVehicleMoveSlow), Fox.GameService.GsRouteDataEdgeEvent.ClassInfo, 0, null, 0);
