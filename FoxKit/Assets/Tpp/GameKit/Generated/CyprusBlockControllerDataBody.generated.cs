...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameKit/CyprusBlockControllerDataBody")]
	public partial class CyprusBlockControllerDataBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static CyprusBlockControllerDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("CyprusBlockControllerDataBody", typeof(CyprusBlockControllerDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
