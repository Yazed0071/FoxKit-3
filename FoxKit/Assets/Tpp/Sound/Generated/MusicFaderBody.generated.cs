...
namespace Tpp.Sound
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppSound/MusicFaderBody")]
	public partial class MusicFaderBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static MusicFaderBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("MusicFaderBody", typeof(MusicFaderBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
