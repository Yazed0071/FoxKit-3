...
namespace Tpp.Sound
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppSound/TppMusicManager")]
	public partial class TppMusicManager : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppMusicManager()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppMusicManager", typeof(TppMusicManager), Fox.Core.Entity.ClassInfo, 0, null, 0);
