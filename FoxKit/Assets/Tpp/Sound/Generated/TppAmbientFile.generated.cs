...
namespace Tpp.Sound
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppSound/TppAmbientFile")]
	public partial class TppAmbientFile : Fox.Core.RawFile
	{
		...
		static TppAmbientFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppAmbientFile", typeof(TppAmbientFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
