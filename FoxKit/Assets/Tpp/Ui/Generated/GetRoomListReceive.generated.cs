...
namespace Tpp.Ui
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppUi/GetRoomListReceive")]
	public partial class GetRoomListReceive : Fox.Core.Entity
	{
		// ClassInfos
		...
		static GetRoomListReceive()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GetRoomListReceive", typeof(GetRoomListReceive), Fox.Core.Entity.ClassInfo, 0, null, 0);
