...
namespace Tpp.Ui
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppUi/GetWormholeAreaListReceive")]
	public partial class GetWormholeAreaListReceive : Fox.Core.Entity
	{
		// ClassInfos
		...
		static GetWormholeAreaListReceive()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GetWormholeAreaListReceive", typeof(GetWormholeAreaListReceive), Fox.Core.Entity.ClassInfo, 0, null, 0);
