...
namespace Tpp.Ui
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppUi/EndingSettingFile")]
	public partial class EndingSettingFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static EndingSettingFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("EndingSettingFile", typeof(EndingSettingFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
