...
namespace Tpp.Ui
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppUi/FultonSoldierReceive")]
	public partial class FultonSoldierReceive : Fox.Core.Entity
	{
		// ClassInfos
		...
		static FultonSoldierReceive()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("FultonSoldierReceive", typeof(FultonSoldierReceive), Fox.Core.Entity.ClassInfo, 0, null, 0);
