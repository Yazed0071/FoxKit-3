...
namespace Tpp.Ui
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppUi/UiCommonDataManager")]
	public partial class UiCommonDataManager : Fox.Core.Entity
	{
		// ClassInfos
		...
		static UiCommonDataManager()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("UiCommonDataManager", typeof(UiCommonDataManager), Fox.Core.Entity.ClassInfo, 0, null, 0);
