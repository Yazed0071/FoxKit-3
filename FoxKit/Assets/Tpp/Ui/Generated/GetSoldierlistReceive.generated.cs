...
namespace Tpp.Ui
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppUi/GetSoldierlistReceive")]
	public partial class GetSoldierlistReceive : Fox.Core.Entity
	{
		// ClassInfos
		...
		static GetSoldierlistReceive()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GetSoldierlistReceive", typeof(GetSoldierlistReceive), Fox.Core.Entity.ClassInfo, 0, null, 0);
