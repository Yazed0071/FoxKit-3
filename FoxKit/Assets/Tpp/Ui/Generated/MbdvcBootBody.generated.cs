...
namespace Tpp.Ui
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppUi/MbdvcBootBody")]
	public partial class MbdvcBootBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static MbdvcBootBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("MbdvcBootBody", typeof(MbdvcBootBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
