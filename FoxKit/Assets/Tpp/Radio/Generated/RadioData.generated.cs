...
namespace Tpp.Radio
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppRadio/RadioData")]
	public partial class RadioData : Fox.Core.Data
	{
		...
		static RadioData()
		{
			if (Fox.Core.Data.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("RadioData", typeof(RadioData), Fox.Core.Data.ClassInfo, 80, "GameKit", 2);
		...
		public override Fox.Core.Value GetProperty(string propertyName)
		{
			...
			{
				case "radioDataFile":
					return new Fox.Core.Value(radioDataFile);
				default:
		...
		public override Fox.Core.Value GetPropertyElement(string propertyName, int index)
		{
			...
			{
				case "radioDataFile":
					return new Fox.Core.Value(this.radioDataFile[index]);
				default:
		...
		public override void RemovePropertyElement(string propertyName, int index)
		{
			...
			{
				case "radioDataFile":
					this.radioDataFile.RemoveAt(index);
					return;
				default:
