...
namespace Tpp.Radio
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppRadio/TppEspionageRadioSystemParameter")]
	public partial class TppEspionageRadioSystemParameter : Fox.Core.DataElement
	{
		...
		static TppEspionageRadioSystemParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppEspionageRadioSystemParameter", typeof(TppEspionageRadioSystemParameter), Fox.Core.DataElement.ClassInfo, 28, null, 0);
