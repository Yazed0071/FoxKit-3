...
namespace Tpp.Radio
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppRadio/RadioDaemon")]
	public partial class RadioDaemon : Fox.Core.Entity
	{
		// ClassInfos
		...
		static RadioDaemon()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("RadioDaemon", typeof(RadioDaemon), Fox.Core.Entity.ClassInfo, 0, null, 0);
