...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppLightProbeArrayBody")]
	public partial class TppLightProbeArrayBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static TppLightProbeArrayBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppLightProbeArrayBody", typeof(TppLightProbeArrayBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
