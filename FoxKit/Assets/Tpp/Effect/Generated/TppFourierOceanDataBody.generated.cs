...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppFourierOceanDataBody")]
	public partial class TppFourierOceanDataBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static TppFourierOceanDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppFourierOceanDataBody", typeof(TppFourierOceanDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
