...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppLightProbeSHCoefficientsBody")]
	public partial class TppLightProbeSHCoefficientsBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static TppLightProbeSHCoefficientsBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppLightProbeSHCoefficientsBody", typeof(TppLightProbeSHCoefficientsBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
