...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppSprintBlur")]
	public partial class TppSprintBlur : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppSprintBlur()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppSprintBlur", typeof(TppSprintBlur), Fox.Core.Entity.ClassInfo, 0, null, 0);
