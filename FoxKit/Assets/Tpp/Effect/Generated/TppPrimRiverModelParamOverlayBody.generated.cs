...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppPrimRiverModelParamOverlayBody")]
	public partial class TppPrimRiverModelParamOverlayBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static TppPrimRiverModelParamOverlayBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppPrimRiverModelParamOverlayBody", typeof(TppPrimRiverModelParamOverlayBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
