...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppSpotLightBody")]
	public partial class TppSpotLightBody : Fox.Core.TransformDataBody
	{
		...
		static TppSpotLightBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppSpotLightBody", typeof(TppSpotLightBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
