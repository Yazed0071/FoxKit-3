...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppDropletsDataBody")]
	public partial class TppDropletsDataBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static TppDropletsDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppDropletsDataBody", typeof(TppDropletsDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
