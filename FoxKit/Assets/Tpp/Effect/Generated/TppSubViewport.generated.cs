...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppSubViewport")]
	public partial class TppSubViewport : Fox.Gr.GrViewport
	{
		// ClassInfos
		...
		static TppSubViewport()
		{
			if (Fox.Gr.GrViewport.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppSubViewport", typeof(TppSubViewport), Fox.Gr.GrViewport.ClassInfo, 0, null, 0);
