...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppCigaretteSmokeGlobalManager")]
	public partial class TppCigaretteSmokeGlobalManager : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppCigaretteSmokeGlobalManager()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppCigaretteSmokeGlobalManager", typeof(TppCigaretteSmokeGlobalManager), Fox.Core.Entity.ClassInfo, 0, null, 0);
