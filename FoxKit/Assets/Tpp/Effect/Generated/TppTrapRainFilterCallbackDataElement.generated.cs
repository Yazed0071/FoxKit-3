...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppTrapRainFilterCallbackDataElement")]
	public partial class TppTrapRainFilterCallbackDataElement : Fox.Geo.GeoTrapModuleCallbackDataElement
	{
		// ClassInfos
		...
		static TppTrapRainFilterCallbackDataElement()
		{
			if (Fox.Geo.GeoTrapModuleCallbackDataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppTrapRainFilterCallbackDataElement", typeof(TppTrapRainFilterCallbackDataElement), Fox.Geo.GeoTrapModuleCallbackDataElement.ClassInfo, 0, null, 0);
