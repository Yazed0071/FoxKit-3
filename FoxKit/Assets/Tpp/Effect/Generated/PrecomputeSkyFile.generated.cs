...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/PrecomputeSkyFile")]
	public partial class PrecomputeSkyFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static PrecomputeSkyFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("PrecomputeSkyFile", typeof(PrecomputeSkyFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
