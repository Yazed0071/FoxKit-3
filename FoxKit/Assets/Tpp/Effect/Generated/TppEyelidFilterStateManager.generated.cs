...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppEyelidFilterStateManager")]
	public partial class TppEyelidFilterStateManager : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppEyelidFilterStateManager()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppEyelidFilterStateManager", typeof(TppEyelidFilterStateManager), Fox.Core.Entity.ClassInfo, 0, null, 0);
