...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppGrenadeShockDataBody")]
	public partial class TppGrenadeShockDataBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static TppGrenadeShockDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppGrenadeShockDataBody", typeof(TppGrenadeShockDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
