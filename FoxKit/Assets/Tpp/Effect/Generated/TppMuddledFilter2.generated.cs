...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppMuddledFilter2")]
	public partial class TppMuddledFilter2 : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppMuddledFilter2()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppMuddledFilter2", typeof(TppMuddledFilter2), Fox.Core.Entity.ClassInfo, 0, null, 0);
