...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppFadeOutEffectHolder")]
	public partial class TppFadeOutEffectHolder : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppFadeOutEffectHolder()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppFadeOutEffectHolder", typeof(TppFadeOutEffectHolder), Fox.Core.Entity.ClassInfo, 0, null, 0);
