...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppLensFlareShapeBody")]
	public partial class TppLensFlareShapeBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static TppLensFlareShapeBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppLensFlareShapeBody", typeof(TppLensFlareShapeBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
