...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppRainFilterBody")]
	public partial class TppRainFilterBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static TppRainFilterBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRainFilterBody", typeof(TppRainFilterBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
