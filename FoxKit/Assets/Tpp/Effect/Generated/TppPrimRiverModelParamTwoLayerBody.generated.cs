...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppPrimRiverModelParamTwoLayerBody")]
	public partial class TppPrimRiverModelParamTwoLayerBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static TppPrimRiverModelParamTwoLayerBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppPrimRiverModelParamTwoLayerBody", typeof(TppPrimRiverModelParamTwoLayerBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
