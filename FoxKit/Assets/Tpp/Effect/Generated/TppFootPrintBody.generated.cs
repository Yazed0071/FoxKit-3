...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppFootPrintBody")]
	public partial class TppFootPrintBody : Fox.Core.TransformDataBody
	{
		...
		static TppFootPrintBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppFootPrintBody", typeof(TppFootPrintBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
