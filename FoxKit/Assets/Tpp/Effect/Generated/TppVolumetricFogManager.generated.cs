...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppVolumetricFogManager")]
	public partial class TppVolumetricFogManager : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppVolumetricFogManager()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppVolumetricFogManager", typeof(TppVolumetricFogManager), Fox.Core.Entity.ClassInfo, 0, null, 0);
