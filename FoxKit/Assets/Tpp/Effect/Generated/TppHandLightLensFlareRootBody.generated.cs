...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppHandLightLensFlareRootBody")]
	public partial class TppHandLightLensFlareRootBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static TppHandLightLensFlareRootBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppHandLightLensFlareRootBody", typeof(TppHandLightLensFlareRootBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
