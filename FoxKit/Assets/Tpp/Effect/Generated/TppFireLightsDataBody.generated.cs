...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppFireLightsDataBody")]
	public partial class TppFireLightsDataBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static TppFireLightsDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppFireLightsDataBody", typeof(TppFireLightsDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
