...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppSandWindDataBody")]
	public partial class TppSandWindDataBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static TppSandWindDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppSandWindDataBody", typeof(TppSandWindDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
