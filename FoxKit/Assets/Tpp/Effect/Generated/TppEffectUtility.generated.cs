...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppEffectUtility")]
	public partial class TppEffectUtility : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppEffectUtility()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppEffectUtility", typeof(TppEffectUtility), Fox.Core.Entity.ClassInfo, 0, null, 0);
