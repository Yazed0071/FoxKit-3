...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppWeatherThunderEffect")]
	public partial class TppWeatherThunderEffect : Tpp.Effect.TppWeatherEffectBase
	{
		// ClassInfos
		...
		static TppWeatherThunderEffect()
		{
			if (Tpp.Effect.TppWeatherEffectBase.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppWeatherThunderEffect", typeof(TppWeatherThunderEffect), Tpp.Effect.TppWeatherEffectBase.ClassInfo, 0, null, 0);
