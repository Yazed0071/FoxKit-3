...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppBrainDamagedFilter")]
	public partial class TppBrainDamagedFilter : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppBrainDamagedFilter()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppBrainDamagedFilter", typeof(TppBrainDamagedFilter), Fox.Core.Entity.ClassInfo, 0, null, 0);
