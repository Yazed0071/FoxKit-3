...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppFloorRainSplashDataBody")]
	public partial class TppFloorRainSplashDataBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static TppFloorRainSplashDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppFloorRainSplashDataBody", typeof(TppFloorRainSplashDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
