...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppEffectCallbackFunction")]
	public partial class TppEffectCallbackFunction : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppEffectCallbackFunction()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppEffectCallbackFunction", typeof(TppEffectCallbackFunction), Fox.Core.Entity.ClassInfo, 0, null, 0);
