...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppHiSpeedDustActor")]
	public partial class TppHiSpeedDustActor : Fox.Core.Actor
	{
		// ClassInfos
		...
		static TppHiSpeedDustActor()
		{
			if (Fox.Core.Actor.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppHiSpeedDustActor", typeof(TppHiSpeedDustActor), Fox.Core.Actor.ClassInfo, 0, null, 0);
