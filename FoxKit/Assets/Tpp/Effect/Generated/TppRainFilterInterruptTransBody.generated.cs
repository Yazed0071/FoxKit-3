...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppRainFilterInterruptTransBody")]
	public partial class TppRainFilterInterruptTransBody : Fox.Core.TransformDataBody
	{
		...
		static TppRainFilterInterruptTransBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRainFilterInterruptTransBody", typeof(TppRainFilterInterruptTransBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
