...
namespace Tpp.Effect
{
	...
	public partial class TppMarshModelPrimitiveBody : Fox.Core.DataBody
	{
		...
		static TppMarshModelPrimitiveBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppMarshModelPrimitiveBody", typeof(TppMarshModelPrimitiveBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
