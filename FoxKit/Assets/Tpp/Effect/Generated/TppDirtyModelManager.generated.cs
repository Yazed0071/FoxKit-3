...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppDirtyModelManager")]
	public partial class TppDirtyModelManager : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppDirtyModelManager()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppDirtyModelManager", typeof(TppDirtyModelManager), Fox.Core.Entity.ClassInfo, 0, null, 0);
