...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppHighSpeedFilter")]
	public partial class TppHighSpeedFilter : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppHighSpeedFilter()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppHighSpeedFilter", typeof(TppHighSpeedFilter), Fox.Core.Entity.ClassInfo, 0, null, 0);
