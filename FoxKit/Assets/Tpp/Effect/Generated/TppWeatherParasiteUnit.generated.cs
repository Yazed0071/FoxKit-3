...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppWeatherParasiteUnit")]
	public partial class TppWeatherParasiteUnit : Tpp.Effect.TppWeatherEffectBase
	{
		// ClassInfos
		...
		static TppWeatherParasiteUnit()
		{
			if (Tpp.Effect.TppWeatherEffectBase.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppWeatherParasiteUnit", typeof(TppWeatherParasiteUnit), Tpp.Effect.TppWeatherEffectBase.ClassInfo, 0, null, 0);
