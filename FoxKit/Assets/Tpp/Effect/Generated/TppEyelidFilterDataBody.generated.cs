...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppEyelidFilterDataBody")]
	public partial class TppEyelidFilterDataBody : Fox.Core.DataBody
	{
		...
		static TppEyelidFilterDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppEyelidFilterDataBody", typeof(TppEyelidFilterDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
