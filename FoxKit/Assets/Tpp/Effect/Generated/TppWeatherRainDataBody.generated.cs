...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppWeatherRainDataBody")]
	public partial class TppWeatherRainDataBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static TppWeatherRainDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppWeatherRainDataBody", typeof(TppWeatherRainDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
