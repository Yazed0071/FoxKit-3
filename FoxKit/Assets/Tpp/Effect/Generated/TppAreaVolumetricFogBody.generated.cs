...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppAreaVolumetricFogBody")]
	public partial class TppAreaVolumetricFogBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static TppAreaVolumetricFogBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppAreaVolumetricFogBody", typeof(TppAreaVolumetricFogBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
