...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppFocusBokehFilterDataBody")]
	public partial class TppFocusBokehFilterDataBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static TppFocusBokehFilterDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppFocusBokehFilterDataBody", typeof(TppFocusBokehFilterDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
