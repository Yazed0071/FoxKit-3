...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppLensFlareMultipleShapeManager")]
	public partial class TppLensFlareMultipleShapeManager : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppLensFlareMultipleShapeManager()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppLensFlareMultipleShapeManager", typeof(TppLensFlareMultipleShapeManager), Fox.Core.Entity.ClassInfo, 0, null, 0);
