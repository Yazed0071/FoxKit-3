...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppMuddledFilter")]
	public partial class TppMuddledFilter : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppMuddledFilter()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppMuddledFilter", typeof(TppMuddledFilter), Fox.Core.Entity.ClassInfo, 0, null, 0);
