...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppFirePropagationLightsDataBody")]
	public partial class TppFirePropagationLightsDataBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static TppFirePropagationLightsDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppFirePropagationLightsDataBody", typeof(TppFirePropagationLightsDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
