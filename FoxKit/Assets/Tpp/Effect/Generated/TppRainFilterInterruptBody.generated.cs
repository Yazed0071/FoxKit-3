...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppRainFilterInterruptBody")]
	public partial class TppRainFilterInterruptBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static TppRainFilterInterruptBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRainFilterInterruptBody", typeof(TppRainFilterInterruptBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
