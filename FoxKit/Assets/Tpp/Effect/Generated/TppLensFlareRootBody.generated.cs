...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppLensFlareRootBody")]
	public partial class TppLensFlareRootBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static TppLensFlareRootBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppLensFlareRootBody", typeof(TppLensFlareRootBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
