...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppDirtyModelController")]
	public partial class TppDirtyModelController : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppDirtyModelController()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppDirtyModelController", typeof(TppDirtyModelController), Fox.Core.Entity.ClassInfo, 0, null, 0);
