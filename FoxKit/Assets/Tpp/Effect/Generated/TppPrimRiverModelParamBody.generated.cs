...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppPrimRiverModelParamBody")]
	public partial class TppPrimRiverModelParamBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static TppPrimRiverModelParamBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppPrimRiverModelParamBody", typeof(TppPrimRiverModelParamBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
