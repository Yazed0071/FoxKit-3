...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppWeatherClimateUpdator")]
	public partial class TppWeatherClimateUpdator : Tpp.Effect.TppWeatherEffectBase
	{
		// ClassInfos
		...
		static TppWeatherClimateUpdator()
		{
			if (Tpp.Effect.TppWeatherEffectBase.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppWeatherClimateUpdator", typeof(TppWeatherClimateUpdator), Tpp.Effect.TppWeatherEffectBase.ClassInfo, 0, null, 0);
