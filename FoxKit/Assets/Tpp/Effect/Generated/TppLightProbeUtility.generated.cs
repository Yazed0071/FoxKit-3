...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppEffect/TppLightProbeUtility")]
	public partial class TppLightProbeUtility : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppLightProbeUtility()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppLightProbeUtility", typeof(TppLightProbeUtility), Fox.Core.Entity.ClassInfo, 0, null, 0);
