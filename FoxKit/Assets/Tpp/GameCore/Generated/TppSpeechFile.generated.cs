...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppSpeechFile")]
	public partial class TppSpeechFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static TppSpeechFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppSpeechFile", typeof(TppSpeechFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
