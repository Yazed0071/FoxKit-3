...
namespace Tpp.GameCore
{
	...
	public partial class TppHidePointDataBody : Fox.Core.TransformDataBody
	{
		...
		static TppHidePointDataBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppHidePointDataBody", typeof(TppHidePointDataBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
