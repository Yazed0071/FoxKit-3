...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppBossQuiet2Parameter")]
	public partial class TppBossQuiet2Parameter : Fox.Core.DataElement
	{
		// Properties
		...
		static TppBossQuiet2Parameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppBossQuiet2Parameter", typeof(TppBossQuiet2Parameter), Fox.Core.DataElement.ClassInfo, 176, null, 0);
