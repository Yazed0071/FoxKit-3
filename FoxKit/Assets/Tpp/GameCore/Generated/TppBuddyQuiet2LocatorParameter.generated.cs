...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppBuddyQuiet2LocatorParameter")]
	public partial class TppBuddyQuiet2LocatorParameter : Fox.Core.DataElement
	{
		// Properties
		...
		static TppBuddyQuiet2LocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppBuddyQuiet2LocatorParameter", typeof(TppBuddyQuiet2LocatorParameter), Fox.Core.DataElement.ClassInfo, 32, null, 0);
