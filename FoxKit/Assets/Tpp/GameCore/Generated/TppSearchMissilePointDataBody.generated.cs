...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppSearchMissilePointDataBody")]
	public partial class TppSearchMissilePointDataBody : Fox.Core.TransformDataBody
	{
		...
		static TppSearchMissilePointDataBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppSearchMissilePointDataBody", typeof(TppSearchMissilePointDataBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
