...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppPlayer2BlockControllerDataBody")]
	public partial class TppPlayer2BlockControllerDataBody : Fox.Core.DataBody
	{
		...
		static TppPlayer2BlockControllerDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppPlayer2BlockControllerDataBody", typeof(TppPlayer2BlockControllerDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
