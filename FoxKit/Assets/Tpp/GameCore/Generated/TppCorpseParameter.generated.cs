...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppCorpseParameter")]
	public partial class TppCorpseParameter : Fox.Core.DataElement
	{
		// Properties
		...
		static TppCorpseParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppCorpseParameter", typeof(TppCorpseParameter), Fox.Core.DataElement.ClassInfo, 176, null, 0);
