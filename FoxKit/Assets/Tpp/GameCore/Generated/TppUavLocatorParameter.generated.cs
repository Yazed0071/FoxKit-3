...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppUavLocatorParameter")]
	public partial class TppUavLocatorParameter : Fox.Core.DataElement
	{
		// Properties
		...
		static TppUavLocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppUavLocatorParameter", typeof(TppUavLocatorParameter), Fox.Core.DataElement.ClassInfo, 32, null, 0);
