...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppHorse2forVrParameter")]
	public partial class TppHorse2forVrParameter : Fox.Core.DataElement
	{
		// Properties
		...
		static TppHorse2forVrParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppHorse2forVrParameter", typeof(TppHorse2forVrParameter), Fox.Core.DataElement.ClassInfo, 152, null, 0);
