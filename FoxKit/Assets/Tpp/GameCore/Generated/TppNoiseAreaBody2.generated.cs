...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppNoiseAreaBody2")]
	public partial class TppNoiseAreaBody2 : Fox.Core.DataBody
	{
		...
		static TppNoiseAreaBody2()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppNoiseAreaBody2", typeof(TppNoiseAreaBody2), Fox.Core.DataBody.ClassInfo, 0, null, 0);
