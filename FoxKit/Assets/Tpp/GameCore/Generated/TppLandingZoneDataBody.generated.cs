...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppLandingZoneDataBody")]
	public partial class TppLandingZoneDataBody : Fox.Core.TransformDataBody
	{
		...
		static TppLandingZoneDataBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppLandingZoneDataBody", typeof(TppLandingZoneDataBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
