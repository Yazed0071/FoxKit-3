...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppRat2LocatorParameter")]
	public partial class TppRat2LocatorParameter : Fox.Core.DataElement
	{
		...
		static TppRat2LocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppRat2LocatorParameter", typeof(TppRat2LocatorParameter), Fox.Core.DataElement.ClassInfo, 36, null, 0);
