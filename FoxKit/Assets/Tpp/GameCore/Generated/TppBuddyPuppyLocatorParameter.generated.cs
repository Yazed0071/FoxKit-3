...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppBuddyPuppyLocatorParameter")]
	public partial class TppBuddyPuppyLocatorParameter : Fox.Core.DataElement
	{
		// ClassInfos
		...
		static TppBuddyPuppyLocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppBuddyPuppyLocatorParameter", typeof(TppBuddyPuppyLocatorParameter), Fox.Core.DataElement.ClassInfo, 28, null, 0);
