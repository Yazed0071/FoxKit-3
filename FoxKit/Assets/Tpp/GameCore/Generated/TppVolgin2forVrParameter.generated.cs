...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppVolgin2forVrParameter")]
	public partial class TppVolgin2forVrParameter : Fox.Core.DataElement
	{
		...
		static TppVolgin2forVrParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppVolgin2forVrParameter", typeof(TppVolgin2forVrParameter), Fox.Core.DataElement.ClassInfo, 104, null, 0);
