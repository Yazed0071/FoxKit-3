...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppSimpleGameSequenceSystem")]
	public partial class TppSimpleGameSequenceSystem : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TppSimpleGameSequenceSystem()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppSimpleGameSequenceSystem", typeof(TppSimpleGameSequenceSystem), Fox.Core.Entity.ClassInfo, 0, null, 0);
