...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppHorse2LocatorParameter")]
	public partial class TppHorse2LocatorParameter : Fox.Core.DataElement
	{
		// Properties
		...
		static TppHorse2LocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppHorse2LocatorParameter", typeof(TppHorse2LocatorParameter), Fox.Core.DataElement.ClassInfo, 32, null, 0);
