...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppHostage2LocatorParameter")]
	public partial class TppHostage2LocatorParameter : Fox.Core.DataElement
	{
		...
		static TppHostage2LocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppHostage2LocatorParameter", typeof(TppHostage2LocatorParameter), Fox.Core.DataElement.ClassInfo, 32, null, 0);
