...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppVolgin2forVrLocatorParameter")]
	public partial class TppVolgin2forVrLocatorParameter : Fox.Core.DataElement
	{
		...
		static TppVolgin2forVrLocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppVolgin2forVrLocatorParameter", typeof(TppVolgin2forVrLocatorParameter), Fox.Core.DataElement.ClassInfo, 32, null, 0);
