...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppWalkerGear2LocatorParameter")]
	public partial class TppWalkerGear2LocatorParameter : Fox.Core.DataElement
	{
		...
		static TppWalkerGear2LocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppWalkerGear2LocatorParameter", typeof(TppWalkerGear2LocatorParameter), Fox.Core.DataElement.ClassInfo, 32, null, 0);
