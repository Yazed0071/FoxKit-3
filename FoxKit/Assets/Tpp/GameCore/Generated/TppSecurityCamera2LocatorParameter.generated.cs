...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppSecurityCamera2LocatorParameter")]
	public partial class TppSecurityCamera2LocatorParameter : Fox.Core.DataElement
	{
		...
		static TppSecurityCamera2LocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppSecurityCamera2LocatorParameter", typeof(TppSecurityCamera2LocatorParameter), Fox.Core.DataElement.ClassInfo, 32, null, 0);
