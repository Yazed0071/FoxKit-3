...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppHorse2forVrLocatorParameter")]
	public partial class TppHorse2forVrLocatorParameter : Fox.Core.DataElement
	{
		...
		static TppHorse2forVrLocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppHorse2forVrLocatorParameter", typeof(TppHorse2forVrLocatorParameter), Fox.Core.DataElement.ClassInfo, 32, null, 0);
