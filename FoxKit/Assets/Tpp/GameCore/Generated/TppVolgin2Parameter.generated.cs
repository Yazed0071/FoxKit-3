...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppVolgin2Parameter")]
	public partial class TppVolgin2Parameter : Fox.Core.DataElement
	{
		...
		static TppVolgin2Parameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppVolgin2Parameter", typeof(TppVolgin2Parameter), Fox.Core.DataElement.ClassInfo, 104, null, 0);
