...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppSampleGameObjectParameter")]
	public partial class TppSampleGameObjectParameter : Fox.Core.DataElement
	{
		...
		static TppSampleGameObjectParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppSampleGameObjectParameter", typeof(TppSampleGameObjectParameter), Fox.Core.DataElement.ClassInfo, 0, null, 0);
		...
		public override Fox.Core.Value GetProperty(string propertyName)
		{
			...
			{
				case "text":
					return new Fox.Core.Value(text);
				default:
