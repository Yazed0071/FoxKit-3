...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppSahelan2LocatorParameter")]
	public partial class TppSahelan2LocatorParameter : Fox.Core.DataElement
	{
		...
		static TppSahelan2LocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppSahelan2LocatorParameter", typeof(TppSahelan2LocatorParameter), Fox.Core.DataElement.ClassInfo, 32, null, 0);
