...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppSimpleMissionBlockControllerDataBody")]
	public partial class TppSimpleMissionBlockControllerDataBody : Fox.Core.DataBody
	{
		...
		static TppSimpleMissionBlockControllerDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppSimpleMissionBlockControllerDataBody", typeof(TppSimpleMissionBlockControllerDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
