...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppParasite2LocatorParameter")]
	public partial class TppParasite2LocatorParameter : Fox.Core.DataElement
	{
		// ClassInfos
		...
		static TppParasite2LocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppParasite2LocatorParameter", typeof(TppParasite2LocatorParameter), Fox.Core.DataElement.ClassInfo, 28, null, 0);
