...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppSoldier2LocatorParameter")]
	public partial class TppSoldier2LocatorParameter : Fox.Core.DataElement
	{
		// Properties
		...
		static TppSoldier2LocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppSoldier2LocatorParameter", typeof(TppSoldier2LocatorParameter), Fox.Core.DataElement.ClassInfo, 32, null, 0);
