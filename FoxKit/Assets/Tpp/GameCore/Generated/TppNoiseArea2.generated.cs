	...
	public partial class TppNoiseArea2 : Fox.Core.Data
	{
		...
		static TppNoiseArea2()
		{
			if (Fox.Core.Data.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppNoiseArea2", typeof(TppNoiseArea2), Fox.Core.Data.ClassInfo, 88, null, 1);
		...
		public override Fox.Core.Value GetProperty(string propertyName)
		{
			switch (propertyName)
			{
				...
				case "areaIndex":
					return new Fox.Core.Value(areaIndex);
				case "subIndex":
					return new Fox.Core.Value(subIndex);
				default:
