...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppHeli2LocatorParameter")]
	public partial class TppHeli2LocatorParameter : Fox.Core.DataElement
	{
		// ClassInfos
		...
		static TppHeli2LocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppHeli2LocatorParameter", typeof(TppHeli2LocatorParameter), Fox.Core.DataElement.ClassInfo, 28, null, 0);
