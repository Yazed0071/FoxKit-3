...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppSnipePoint2DataBody")]
	public partial class TppSnipePoint2DataBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static TppSnipePoint2DataBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppSnipePoint2DataBody", typeof(TppSnipePoint2DataBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
