...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppTrapExecLostHostageCallbackDataElement")]
	public partial class TppTrapExecLostHostageCallbackDataElement : Fox.Geo.GeoTrapModuleCallbackDataElement
	{
		...
		static TppTrapExecLostHostageCallbackDataElement()
		{
			if (Fox.Geo.GeoTrapModuleCallbackDataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppTrapExecLostHostageCallbackDataElement", typeof(TppTrapExecLostHostageCallbackDataElement), Fox.Geo.GeoTrapModuleCallbackDataElement.ClassInfo, 36, null, 0);
		...
		public override Fox.Core.Value GetProperty(string propertyName)
		{
			...
			{
				case "hostageName":
					return new Fox.Core.Value(hostageName);
				default:
