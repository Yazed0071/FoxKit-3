...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppSampleGameObjectLocatorParameter")]
	public partial class TppSampleGameObjectLocatorParameter : Fox.Core.DataElement
	{
		...
		static TppSampleGameObjectLocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppSampleGameObjectLocatorParameter", typeof(TppSampleGameObjectLocatorParameter), Fox.Core.DataElement.ClassInfo, 0, null, 0);
