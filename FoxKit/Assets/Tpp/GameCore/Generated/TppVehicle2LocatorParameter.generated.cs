...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppVehicle2LocatorParameter")]
	public partial class TppVehicle2LocatorParameter : Fox.Core.DataElement
	{
		// ClassInfos
		...
		static TppVehicle2LocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppVehicle2LocatorParameter", typeof(TppVehicle2LocatorParameter), Fox.Core.DataElement.ClassInfo, 28, null, 2);
