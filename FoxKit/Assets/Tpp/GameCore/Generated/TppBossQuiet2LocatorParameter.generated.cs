...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppBossQuiet2LocatorParameter")]
	public partial class TppBossQuiet2LocatorParameter : Fox.Core.DataElement
	{
		...
		static TppBossQuiet2LocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppBossQuiet2LocatorParameter", typeof(TppBossQuiet2LocatorParameter), Fox.Core.DataElement.ClassInfo, 32, null, 0);
