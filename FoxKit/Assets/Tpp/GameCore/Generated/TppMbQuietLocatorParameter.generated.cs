...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("TppGameCore/TppMbQuietLocatorParameter")]
	public partial class TppMbQuietLocatorParameter : Fox.Core.DataElement
	{
		// Properties
		...
		static TppMbQuietLocatorParameter()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TppMbQuietLocatorParameter", typeof(TppMbQuietLocatorParameter), Fox.Core.DataElement.ClassInfo, 32, null, 0);
