...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Character/GkPathLineTarget")]
	public partial class GkPathLineTarget : Fox.Graphx.GraphxPathData
	{
		...
		static GkPathLineTarget()
		{
			if (Fox.Graphx.GraphxPathData.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GkPathLineTarget", typeof(GkPathLineTarget), Fox.Graphx.GraphxPathData.ClassInfo, 288, "Character", 0);
