...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/WindManager")]
	public partial class WindManager : Fox.GameKit.EnvironmentManager
	{
		// ClassInfos
		...
		static WindManager()
		{
			if (Fox.GameKit.EnvironmentManager.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("WindManager", typeof(WindManager), Fox.GameKit.EnvironmentManager.ClassInfo, 0, null, 0);
