...
namespace Fox.GameKit
{
	...
	public partial class CheckpointObserver : Fox.Core.Entity
	{
		...
		protected string observerTag { get; set; }
		...
		static CheckpointObserver()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("CheckpointObserver", typeof(CheckpointObserver), Fox.Core.Entity.ClassInfo, 0, "GameKit", 0);
		...
		public override Fox.Core.Value GetProperty(string propertyName)
		{
			...
			{
				case "observerTag":
					return new Fox.Core.Value(observerTag);
				default:
