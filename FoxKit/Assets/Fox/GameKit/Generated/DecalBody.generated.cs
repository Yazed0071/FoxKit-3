...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/DecalBody")]
	public partial class DecalBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static DecalBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("DecalBody", typeof(DecalBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
