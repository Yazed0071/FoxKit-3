...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/GameSequenceController")]
	public partial class GameSequenceController : Fox.Core.Entity
	{
		// ClassInfos
		...
		static GameSequenceController()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GameSequenceController", typeof(GameSequenceController), Fox.Core.Entity.ClassInfo, 0, null, 0);
