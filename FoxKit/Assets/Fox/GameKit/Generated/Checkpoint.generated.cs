...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/Checkpoint")]
	public partial class Checkpoint : Fox.Core.Entity
	{
		// ClassInfos
		...
		static Checkpoint()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("Checkpoint", typeof(Checkpoint), Fox.Core.Entity.ClassInfo, 0, "GameKit", 0);
