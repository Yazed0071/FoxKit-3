...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/EnvironmentManager")]
	public partial class EnvironmentManager : Fox.Core.Entity
	{
		// ClassInfos
		...
		static EnvironmentManager()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("EnvironmentManager", typeof(EnvironmentManager), Fox.Core.Entity.ClassInfo, 0, null, 0);
