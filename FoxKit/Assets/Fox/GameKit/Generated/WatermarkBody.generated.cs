...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/WatermarkBody")]
	public partial class WatermarkBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static WatermarkBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("WatermarkBody", typeof(WatermarkBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
