...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/TexturePackLoadConditionerBody")]
	public partial class TexturePackLoadConditionerBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static TexturePackLoadConditionerBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TexturePackLoadConditionerBody", typeof(TexturePackLoadConditionerBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
