...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/SubtitlesBlockControllerDataBody")]
	public partial class SubtitlesBlockControllerDataBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static SubtitlesBlockControllerDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SubtitlesBlockControllerDataBody", typeof(SubtitlesBlockControllerDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
