...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/GkEventTimerManager")]
	public partial class GkEventTimerManager : Fox.Core.Entity
	{
		// ClassInfos
		...
		static GkEventTimerManager()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GkEventTimerManager", typeof(GkEventTimerManager), Fox.Core.Entity.ClassInfo, 0, "GameKit", 0);
