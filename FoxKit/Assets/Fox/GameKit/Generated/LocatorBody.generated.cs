...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/LocatorBody")]
	public partial class LocatorBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static LocatorBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("LocatorBody", typeof(LocatorBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
