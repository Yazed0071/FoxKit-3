...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/OverlayModelBody")]
	public partial class OverlayModelBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static OverlayModelBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("OverlayModelBody", typeof(OverlayModelBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
