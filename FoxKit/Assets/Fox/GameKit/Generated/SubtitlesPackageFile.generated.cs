...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/SubtitlesPackageFile")]
	public partial class SubtitlesPackageFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static SubtitlesPackageFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SubtitlesPackageFile", typeof(SubtitlesPackageFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
