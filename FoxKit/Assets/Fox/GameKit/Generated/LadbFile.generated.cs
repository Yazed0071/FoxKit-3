...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/LadbFile")]
	public partial class LadbFile : Fox.Core.RawFile
	{
		...
		static LadbFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("LadbFile", typeof(LadbFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
