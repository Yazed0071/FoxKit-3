...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/PadMapping")]
	public partial class PadMapping : Fox.Core.Entity
	{
		// ClassInfos
		...
		static PadMapping()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("PadMapping", typeof(PadMapping), Fox.Core.Entity.ClassInfo, 0, null, 0);
