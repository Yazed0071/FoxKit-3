...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/SubtitlesDaemon")]
	public partial class SubtitlesDaemon : Fox.Core.Entity
	{
		// ClassInfos
		...
		static SubtitlesDaemon()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SubtitlesDaemon", typeof(SubtitlesDaemon), Fox.Core.Entity.ClassInfo, 0, null, 0);
