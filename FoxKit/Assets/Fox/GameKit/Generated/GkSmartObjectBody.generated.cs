...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/GkSmartObjectBody")]
	public partial class GkSmartObjectBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static GkSmartObjectBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GkSmartObjectBody", typeof(GkSmartObjectBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
