...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/PauseController")]
	public partial class PauseController : Fox.Core.Actor
	{
		// ClassInfos
		...
		static PauseController()
		{
			if (Fox.Core.Actor.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("PauseController", typeof(PauseController), Fox.Core.Actor.ClassInfo, 0, null, 0);
