...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/FoxFadeIo")]
	public partial class FoxFadeIo : Fox.Core.Actor
	{
		// ClassInfos
		...
		static FoxFadeIo()
		{
			if (Fox.Core.Actor.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("FoxFadeIo", typeof(FoxFadeIo), Fox.Core.Actor.ClassInfo, 0, null, 0);
