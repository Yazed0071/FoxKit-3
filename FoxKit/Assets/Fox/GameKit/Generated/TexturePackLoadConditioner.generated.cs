...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/TexturePackLoadConditioner")]
	public partial class TexturePackLoadConditioner : Fox.Core.Data
	{
		// Properties
		[field: UnityEngine.SerializeField]
		public Fox.Path texturePackPath { get; set; }
		...
		static TexturePackLoadConditioner()
		{
			if (Fox.Core.Data.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TexturePackLoadConditioner", typeof(TexturePackLoadConditioner), Fox.Core.Data.ClassInfo, 72, "Texture", 0);
		...
		public override Fox.Core.Value GetProperty(string propertyName)
		{
			switch (propertyName)
			{
				case "texturePackPath":
					return new Fox.Core.Value(texturePackPath);
				default:
