...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/EnvironmentDaemon")]
	public partial class EnvironmentDaemon : Fox.Core.Entity
	{
		// ClassInfos
		...
		static EnvironmentDaemon()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("EnvironmentDaemon", typeof(EnvironmentDaemon), Fox.Core.Entity.ClassInfo, 0, null, 0);
