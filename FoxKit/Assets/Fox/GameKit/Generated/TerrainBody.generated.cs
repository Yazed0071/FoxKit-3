...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/TerrainBody")]
	public partial class TerrainBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static TerrainBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TerrainBody", typeof(TerrainBody), Fox.Core.TransformDataBody.ClassInfo, 0, "Terrain", 1);
