...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/CameraPriority")]
	public partial class CameraPriority : Fox.Core.Entity
	{
		// ClassInfos
		...
		static CameraPriority()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("CameraPriority", typeof(CameraPriority), Fox.Core.Entity.ClassInfo, 0, null, 0);
