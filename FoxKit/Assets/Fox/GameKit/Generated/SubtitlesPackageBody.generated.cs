...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/SubtitlesPackageBody")]
	public partial class SubtitlesPackageBody : Fox.Core.DataBody
	{
		...
		static SubtitlesPackageBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SubtitlesPackageBody", typeof(SubtitlesPackageBody), Fox.Core.DataBody.ClassInfo, 0, "Subtitles", 0);
