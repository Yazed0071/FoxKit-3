...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/EnvironmentObject")]
	public partial class EnvironmentObject : Fox.Core.Entity
	{
		...
		static EnvironmentObject()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("EnvironmentObject", typeof(EnvironmentObject), Fox.Core.Entity.ClassInfo, 0, null, 0);
