...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/ObjectBrushPluginStaticModelBody")]
	public partial class ObjectBrushPluginStaticModelBody : Fox.GameKit.ObjectBrushPluginBody
	{
		...
		static ObjectBrushPluginStaticModelBody()
		{
			if (Fox.GameKit.ObjectBrushPluginBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("ObjectBrushPluginStaticModelBody", typeof(ObjectBrushPluginStaticModelBody), Fox.GameKit.ObjectBrushPluginBody.ClassInfo, 0, "ObjectBrush", 0);
