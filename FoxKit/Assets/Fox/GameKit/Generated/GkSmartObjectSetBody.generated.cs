...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/GkSmartObjectSetBody")]
	public partial class GkSmartObjectSetBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static GkSmartObjectSetBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GkSmartObjectSetBody", typeof(GkSmartObjectSetBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
