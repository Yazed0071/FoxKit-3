...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/TerrainRenderBody")]
	public partial class TerrainRenderBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static TerrainRenderBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TerrainRenderBody", typeof(TerrainRenderBody), Fox.Core.TransformDataBody.ClassInfo, 0, "TerrainRender", 0);
