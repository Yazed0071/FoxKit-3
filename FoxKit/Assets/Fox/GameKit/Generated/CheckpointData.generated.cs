...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/CheckpointData")]
	public partial class CheckpointData : Fox.Core.Entity
	{
		// ClassInfos
		...
		static CheckpointData()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("CheckpointData", typeof(CheckpointData), Fox.Core.Entity.ClassInfo, 0, "GameKit", 0);
