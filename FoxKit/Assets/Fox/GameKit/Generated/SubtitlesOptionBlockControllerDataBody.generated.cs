...
namespace Fox.GameKit
{
	...
	public partial class SubtitlesOptionBlockControllerDataBody : Fox.Core.DataBody
	{
		...
		static SubtitlesOptionBlockControllerDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SubtitlesOptionBlockControllerDataBody", typeof(SubtitlesOptionBlockControllerDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
