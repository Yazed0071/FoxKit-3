...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/SubtitlesOptionBlockControllerData")]
	public partial class SubtitlesOptionBlockControllerData : Fox.Core.Data
	{
		...
		static SubtitlesOptionBlockControllerData()
		{
			if (Fox.Core.Data.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SubtitlesOptionBlockControllerData", typeof(SubtitlesOptionBlockControllerData), Fox.Core.Data.ClassInfo, 88, "Subtitles", 0);
		...
		public override Fox.Core.Value GetProperty(string propertyName)
		{
			switch (propertyName)
			{
				case "packageFileNames":
					return new Fox.Core.Value(packageFileNames);
				default:
		...
		public override Fox.Core.Value GetPropertyElement(string propertyName, int index)
		{
			...
			{
				case "packageFileNames":
					return new Fox.Core.Value(this.packageFileNames[index]);
				default:
		...
		public override void RemovePropertyElement(string propertyName, int index)
		{
			...
			{
				case "packageFileNames":
					this.packageFileNames.RemoveAt(index);
					return;
				default:
