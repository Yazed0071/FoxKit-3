...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/GkSightCheckParam")]
	public partial class GkSightCheckParam : Fox.Core.Entity
	{
		// ClassInfos
		...
		static GkSightCheckParam()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GkSightCheckParam", typeof(GkSightCheckParam), Fox.Core.Entity.ClassInfo, 0, null, 0);
