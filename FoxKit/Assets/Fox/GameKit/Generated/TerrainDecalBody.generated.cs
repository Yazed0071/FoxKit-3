...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/TerrainDecalBody")]
	public partial class TerrainDecalBody : Fox.Core.TransformDataBody
	{
		...
		static TerrainDecalBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TerrainDecalBody", typeof(TerrainDecalBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
