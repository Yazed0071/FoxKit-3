...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/SubtitlesTrapConditionBody")]
	public partial class SubtitlesTrapConditionBody : Fox.Geo.GeoTrapConditionBody
	{
		// ClassInfos
		...
		static SubtitlesTrapConditionBody()
		{
			if (Fox.Geo.GeoTrapConditionBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SubtitlesTrapConditionBody", typeof(SubtitlesTrapConditionBody), Fox.Geo.GeoTrapConditionBody.ClassInfo, 0, null, 0);
