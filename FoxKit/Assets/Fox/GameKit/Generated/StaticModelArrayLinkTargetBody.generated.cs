...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/StaticModelArrayLinkTargetBody")]
	public partial class StaticModelArrayLinkTargetBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static StaticModelArrayLinkTargetBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("StaticModelArrayLinkTargetBody", typeof(StaticModelArrayLinkTargetBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
