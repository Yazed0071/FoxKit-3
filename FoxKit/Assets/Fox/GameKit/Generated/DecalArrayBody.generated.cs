...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/DecalArrayBody")]
	public partial class DecalArrayBody : Fox.Core.TransformDataBody
	{
		...
		static DecalArrayBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("DecalArrayBody", typeof(DecalArrayBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 1);
