...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/WindObject")]
	public partial class WindObject : Fox.GameKit.EnvironmentObject
	{
		...
		static WindObject()
		{
			if (Fox.GameKit.EnvironmentObject.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("WindObject", typeof(WindObject), Fox.GameKit.EnvironmentObject.ClassInfo, 0, null, 0);
