...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/LevelingTerrainBody")]
	public partial class LevelingTerrainBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static LevelingTerrainBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("LevelingTerrainBody", typeof(LevelingTerrainBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
