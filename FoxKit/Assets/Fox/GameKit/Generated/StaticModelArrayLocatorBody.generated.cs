...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/StaticModelArrayLocatorBody")]
	public partial class StaticModelArrayLocatorBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static StaticModelArrayLocatorBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("StaticModelArrayLocatorBody", typeof(StaticModelArrayLocatorBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
