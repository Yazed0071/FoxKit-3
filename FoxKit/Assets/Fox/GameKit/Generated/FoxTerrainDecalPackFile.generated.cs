...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/FoxTerrainDecalPackFile")]
	public partial class FoxTerrainDecalPackFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static FoxTerrainDecalPackFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("FoxTerrainDecalPackFile", typeof(FoxTerrainDecalPackFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
