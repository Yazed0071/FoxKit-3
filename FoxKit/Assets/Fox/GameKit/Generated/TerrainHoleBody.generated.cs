...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxGameKit/TerrainHoleBody")]
	public partial class TerrainHoleBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static TerrainHoleBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TerrainHoleBody", typeof(TerrainHoleBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
