...
namespace Fox.Grx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Grx/HorizonBody")]
	public partial class HorizonBody : Fox.Core.TransformDataBody
	{
		...
		static HorizonBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("HorizonBody", typeof(HorizonBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
