...
namespace Fox.Grx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Grx/GlobalCameraSettingsBody")]
	public partial class GlobalCameraSettingsBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static GlobalCameraSettingsBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GlobalCameraSettingsBody", typeof(GlobalCameraSettingsBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
