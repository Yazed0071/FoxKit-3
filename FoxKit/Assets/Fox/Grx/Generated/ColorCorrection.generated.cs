...
namespace Fox.Grx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Grx/ColorCorrection")]
	public partial class ColorCorrection : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static ColorCorrection()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("ColorCorrection", typeof(ColorCorrection), Fox.Core.DataBody.ClassInfo, 0, null, 0);
