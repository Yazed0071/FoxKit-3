...
namespace Fox.Grx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Grx/GrxUtil")]
	public partial class GrxUtil : Fox.Core.Entity
	{
		// ClassInfos
		...
		static GrxUtil()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrxUtil", typeof(GrxUtil), Fox.Core.Entity.ClassInfo, 0, null, 0);
