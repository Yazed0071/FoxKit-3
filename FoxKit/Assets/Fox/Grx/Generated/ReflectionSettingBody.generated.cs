...
namespace Fox.Grx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Grx/ReflectionSettingBody")]
	public partial class ReflectionSettingBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static ReflectionSettingBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("ReflectionSettingBody", typeof(ReflectionSettingBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
