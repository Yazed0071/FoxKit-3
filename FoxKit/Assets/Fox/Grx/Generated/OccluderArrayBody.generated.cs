...
namespace Fox.Grx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Grx/OccluderArrayBody")]
	public partial class OccluderArrayBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static OccluderArrayBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("OccluderArrayBody", typeof(OccluderArrayBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
