...
namespace Fox.Grx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Grx/OccluderArray")]
	public partial class OccluderArray : Fox.Core.TransformData
	{
		...
		static OccluderArray()
		{
			if (Fox.Core.TransformData.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("OccluderArray", typeof(OccluderArray), Fox.Core.TransformData.ClassInfo, 288, "Area", 1);
		...
		public override Fox.Core.Value GetProperty(string propertyName)
		{
			switch (propertyName)
			{
				case "occluderArrayFile":
					return new Fox.Core.Value(occluderArrayFile);
				default:
