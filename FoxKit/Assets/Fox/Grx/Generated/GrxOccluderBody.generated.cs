...
namespace Fox.Grx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Grx/GrxOccluderBody")]
	public partial class GrxOccluderBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static GrxOccluderBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrxOccluderBody", typeof(GrxOccluderBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
