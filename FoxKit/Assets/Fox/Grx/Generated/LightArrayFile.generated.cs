...
namespace Fox.Grx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Grx/LightArrayFile")]
	public partial class LightArrayFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static LightArrayFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("LightArrayFile", typeof(LightArrayFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
