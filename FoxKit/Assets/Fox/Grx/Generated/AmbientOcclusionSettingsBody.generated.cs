...
namespace Fox.Grx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Grx/AmbientOcclusionSettingsBody")]
	public partial class AmbientOcclusionSettingsBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static AmbientOcclusionSettingsBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("AmbientOcclusionSettingsBody", typeof(AmbientOcclusionSettingsBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
