...
namespace Fox.Grx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Grx/PluginSettingsBody")]
	public partial class PluginSettingsBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static PluginSettingsBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("PluginSettingsBody", typeof(PluginSettingsBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
