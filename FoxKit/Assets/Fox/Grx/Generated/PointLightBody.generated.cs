...
namespace Fox.Grx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Grx/PointLightBody")]
	public partial class PointLightBody : Fox.Core.TransformDataBody
	{
		...
		static PointLightBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("PointLightBody", typeof(PointLightBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
