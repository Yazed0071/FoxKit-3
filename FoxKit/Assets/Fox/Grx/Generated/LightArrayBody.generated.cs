...
namespace Fox.Grx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Grx/LightArrayBody")]
	public partial class LightArrayBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static LightArrayBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("LightArrayBody", typeof(LightArrayBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
