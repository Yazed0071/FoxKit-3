...
namespace Fox.Grx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Grx/GrxOccluderExBody")]
	public partial class GrxOccluderExBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static GrxOccluderExBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrxOccluderExBody", typeof(GrxOccluderExBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
