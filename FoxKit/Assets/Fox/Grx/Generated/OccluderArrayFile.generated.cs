...
namespace Fox.Grx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Grx/OccluderArrayFile")]
	public partial class OccluderArrayFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static OccluderArrayFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("OccluderArrayFile", typeof(OccluderArrayFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
