...
namespace Fox.Ph
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Ph/PhMaterialManager")]
	public partial class PhMaterialManager : Fox.Core.Entity
	{
		// ClassInfos
		...
		static PhMaterialManager()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("PhMaterialManager", typeof(PhMaterialManager), Fox.Core.Entity.ClassInfo, 0, "Ph", 0);
