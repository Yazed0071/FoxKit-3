...
namespace Fox.Ph
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Ph/PhActionParam")]
	public partial class PhActionParam : Fox.Core.Entity
	{
		...
		static PhActionParam()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("PhActionParam", typeof(PhActionParam), Fox.Core.Entity.ClassInfo, 0, "Ph", 0);
