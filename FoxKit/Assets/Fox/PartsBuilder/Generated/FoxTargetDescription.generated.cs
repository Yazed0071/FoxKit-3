...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("PartsBuilder/FoxTargetDescription")]
	public partial class FoxTargetDescription : Fox.PartsBuilder.PartDescription
	{
		// Properties
		[field: UnityEngine.SerializeField]
		public Fox.Core.FilePtr targetFile { get; set; }
		...
		static FoxTargetDescription()
		{
			if (Fox.PartsBuilder.PartDescription.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("FoxTargetDescription", typeof(FoxTargetDescription), Fox.PartsBuilder.PartDescription.ClassInfo, 112, "PartsBuilder", 1);
		...
		public override Fox.Core.Value GetProperty(string propertyName)
		{
			...
			{
				case "targetFile":
					return new Fox.Core.Value(targetFile);
				default:
