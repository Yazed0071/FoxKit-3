...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("PartsBuilder/VehicleDescription")]
	public partial class VehicleDescription : Fox.PartsBuilder.PartDescription
	{
		// Properties
		[field: UnityEngine.SerializeField]
		public Fox.Core.FilePtr vehicleFile { get; set; }
		...
		static VehicleDescription()
		{
			if (Fox.PartsBuilder.PartDescription.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("VehicleDescription", typeof(VehicleDescription), Fox.PartsBuilder.PartDescription.ClassInfo, 112, "PartsBuilder", 0);
		...
		public override Fox.Core.Value GetProperty(string propertyName)
		{
			...
			{
				case "vehicleFile":
					return new Fox.Core.Value(vehicleFile);
				default:
		...
		public override void SetProperty(string propertyName, Fox.Core.Value value)
		{
			...
			{
				case "vehicleFile":
					this.vehicleFile = value.GetValueAsFilePtr();
					return;
				default:
