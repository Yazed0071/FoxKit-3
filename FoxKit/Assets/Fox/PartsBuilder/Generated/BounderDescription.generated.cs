...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("PartsBuilder/BounderDescription")]
	public partial class BounderDescription : Fox.PartsBuilder.PartDescription
	{
		...
		static BounderDescription()
		{
			if (Fox.PartsBuilder.PartDescription.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("BounderDescription", typeof(BounderDescription), Fox.PartsBuilder.PartDescription.ClassInfo, 0, "PartsBuilder", 0);
		...
		public override Fox.Core.Value GetProperty(string propertyName)
		{
			...
			{
				case "bounderFile":
					return new Fox.Core.Value(bounderFile);
				default:
