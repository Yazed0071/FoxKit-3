...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("GameService/GsRouteData")]
	public partial class GsRouteData : Fox.Graphx.GraphxSpatialGraphData
	{
		...
		static GsRouteData()
		{
			if (Fox.Graphx.GraphxSpatialGraphData.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GsRouteData", typeof(GsRouteData), Fox.Graphx.GraphxSpatialGraphData.ClassInfo, 0, null, 0);
