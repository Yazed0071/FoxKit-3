...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("GameService/GsRouteDataBody")]
	public partial class GsRouteDataBody : Fox.Graphx.GraphxPath
	{
		// ClassInfos
		...
		static GsRouteDataBody()
		{
			if (Fox.Graphx.GraphxPath.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GsRouteDataBody", typeof(GsRouteDataBody), Fox.Graphx.GraphxPath.ClassInfo, 0, null, 0);
