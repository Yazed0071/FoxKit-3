...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Graphx/GraphxPathVertexInsertionInfo")]
	public partial class GraphxPathVertexInsertionInfo : Fox.Core.ComponentInsertionInfo
	{
		...
		{
			if (Fox.Core.ComponentInsertionInfo.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GraphxPathVertexInsertionInfo", typeof(GraphxPathVertexInsertionInfo), Fox.Core.ComponentInsertionInfo.ClassInfo, 0, null, 0);
