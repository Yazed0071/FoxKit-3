...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Graphx/GraphxPath")]
	public partial class GraphxPath : Fox.Graphx.GraphxSpatialGraph
	{
		...
		static GraphxPath()
		{
			if (Fox.Graphx.GraphxSpatialGraph.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GraphxPath", typeof(GraphxPath), Fox.Graphx.GraphxSpatialGraph.ClassInfo, 0, null, 0);
