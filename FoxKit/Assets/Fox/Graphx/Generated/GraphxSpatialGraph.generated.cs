...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Graphx/GraphxSpatialGraph")]
	public partial class GraphxSpatialGraph : Fox.Core.TransformDataBody
	{
		...
		static GraphxSpatialGraph()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GraphxSpatialGraph", typeof(GraphxSpatialGraph), Fox.Core.TransformDataBody.ClassInfo, 0, "Graphx", 0);
