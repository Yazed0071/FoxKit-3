...
namespace Fox.Nav
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Nav/NavNavigationParameter")]
	public partial class NavNavigationParameter : Fox.Core.Entity
	{
		...
		static NavNavigationParameter()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("NavNavigationParameter", typeof(NavNavigationParameter), Fox.Core.Entity.ClassInfo, 0, "Nav", 0);
