...
namespace Fox.Nav
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Nav/NavWorldDaemon")]
	public partial class NavWorldDaemon : Fox.Core.Entity
	{
		// ClassInfos
		...
		static NavWorldDaemon()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("NavWorldDaemon", typeof(NavWorldDaemon), Fox.Core.Entity.ClassInfo, 0, null, 0);
