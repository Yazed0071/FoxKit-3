...
namespace Fox.Nav
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Nav/NavNavigationParameterHolder")]
	public partial class NavNavigationParameterHolder : Fox.Core.Entity
	{
		...
		static NavNavigationParameterHolder()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("NavNavigationParameterHolder", typeof(NavNavigationParameterHolder), Fox.Core.Entity.ClassInfo, 0, "Nav", 0);
