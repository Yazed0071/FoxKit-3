...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("MotionGraph/MotionGraphBlendValueConverter")]
	public partial class MotionGraphBlendValueConverter : Fox.Core.Entity
	{
		// ClassInfos
		...
		static MotionGraphBlendValueConverter()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("MotionGraphBlendValueConverter", typeof(MotionGraphBlendValueConverter), Fox.Core.Entity.ClassInfo, 0, null, 0);
