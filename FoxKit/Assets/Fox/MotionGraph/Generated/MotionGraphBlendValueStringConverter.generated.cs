...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("MotionGraph/MotionGraphBlendValueStringConverter")]
	public partial class MotionGraphBlendValueStringConverter : Fox.MotionGraph.MotionGraphBlendValueConverter
	{
		// ClassInfos
		...
		static MotionGraphBlendValueStringConverter()
		{
			if (Fox.MotionGraph.MotionGraphBlendValueConverter.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("MotionGraphBlendValueStringConverter", typeof(MotionGraphBlendValueStringConverter), Fox.MotionGraph.MotionGraphBlendValueConverter.ClassInfo, 0, null, 0);
