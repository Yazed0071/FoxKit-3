...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("MotionGraph/MogFile")]
	public partial class MogFile : Fox.Core.RawFile
	{
		...
		static MogFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("MogFile", typeof(MogFile), Fox.Core.RawFile.ClassInfo, 0, null, 6);
