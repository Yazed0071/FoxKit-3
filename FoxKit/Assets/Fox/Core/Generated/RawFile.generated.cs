...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/RawFile")]
	public partial class RawFile : Fox.Core.File
	{
		...
		static RawFile()
		{
			if (Fox.Core.File.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("RawFile", typeof(RawFile), Fox.Core.File.ClassInfo, 0, null, 0);
