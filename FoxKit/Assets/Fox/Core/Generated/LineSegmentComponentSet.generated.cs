...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/LineSegmentComponentSet")]
	public partial class LineSegmentComponentSet : Fox.Core.ComponentSet
	{
		// ClassInfos
		...
		static LineSegmentComponentSet()
		{
			if (Fox.Core.ComponentSet.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("LineSegmentComponentSet", typeof(LineSegmentComponentSet), Fox.Core.ComponentSet.ClassInfo, 0, null, 0);
