...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/Script")]
	public partial class Script : Fox.Core.Entity
	{
		// ClassInfos
		...
		static Script()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("Script", typeof(Script), Fox.Core.Entity.ClassInfo, 0, null, 0);
