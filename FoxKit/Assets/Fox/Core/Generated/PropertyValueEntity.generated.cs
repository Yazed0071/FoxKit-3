...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/PropertyValueEntity")]
	public partial class PropertyValueEntity : Fox.Core.Entity
	{
		// ClassInfos
		...
		static PropertyValueEntity()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("PropertyValueEntity", typeof(PropertyValueEntity), Fox.Core.Entity.ClassInfo, 0, null, 0);
