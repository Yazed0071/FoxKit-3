...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/PassiveBlockController")]
	public partial class PassiveBlockController : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static PassiveBlockController()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("PassiveBlockController", typeof(PassiveBlockController), Fox.Core.DataBody.ClassInfo, 0, null, 0);
