...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/SafeScript")]
	public partial class SafeScript : Fox.Core.Script
	{
		// ClassInfos
		...
		static SafeScript()
		{
			if (Fox.Core.Script.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SafeScript", typeof(SafeScript), Fox.Core.Script.ClassInfo, 0, null, 0);
