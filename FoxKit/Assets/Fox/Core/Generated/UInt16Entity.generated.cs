...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/UInt16Entity")]
	public partial class UInt16Entity : Fox.Core.PropertyValueEntity
	{
		...
		static UInt16Entity()
		{
			if (Fox.Core.PropertyValueEntity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("UInt16Entity", typeof(UInt16Entity), Fox.Core.PropertyValueEntity.ClassInfo, 0, null, 0);
