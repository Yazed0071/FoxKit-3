...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/Int32Entity")]
	public partial class Int32Entity : Fox.Core.PropertyValueEntity
	{
		...
		static Int32Entity()
		{
			if (Fox.Core.PropertyValueEntity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("Int32Entity", typeof(Int32Entity), Fox.Core.PropertyValueEntity.ClassInfo, 0, null, 0);
