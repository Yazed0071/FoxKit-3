...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/DataSetReferenceBody")]
	public partial class DataSetReferenceBody : Fox.Core.TransformDataBody
	{
		...
		static DataSetReferenceBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("DataSetReferenceBody", typeof(DataSetReferenceBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
