...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/Matrix4StringMapPropertyDifference")]
	public partial class Matrix4StringMapPropertyDifference : Fox.Core.PropertyDifference
	{
		// Properties
		[field: UnityEngine.SerializeField]
		public Fox.StringMap<UnityEngine.Matrix4x4> originalValues { get; private set; } = new Fox.StringMap<UnityEngine.Matrix4x4>();
		
		[field: UnityEngine.SerializeField]
		public Fox.StringMap<UnityEngine.Matrix4x4> values { get; private set; } = new Fox.StringMap<UnityEngine.Matrix4x4>();
		...
		static Matrix4StringMapPropertyDifference()
		{
			if (Fox.Core.PropertyDifference.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("Matrix4StringMapPropertyDifference", typeof(Matrix4StringMapPropertyDifference), Fox.Core.PropertyDifference.ClassInfo, 0, null, 0);
		...
		public override void SetPropertyElement(string propertyName, string key, Fox.Core.Value value)
		{
			...
			{
				case "originalValues":
					this.originalValues[key] = value.GetValueAsMatrix4();
					return;
				case "values":
					this.values[key] = value.GetValueAsMatrix4();
					return;
				default:
