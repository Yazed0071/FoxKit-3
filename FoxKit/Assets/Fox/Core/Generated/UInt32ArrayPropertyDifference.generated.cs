...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/UInt32ArrayPropertyDifference")]
	public partial class UInt32ArrayPropertyDifference : Fox.Core.PropertyDifference
	{
		// Properties
		[field: UnityEngine.SerializeField]
		public CsSystem.Collections.Generic.List<uint> originalValues { get; private set; } = new CsSystem.Collections.Generic.List<uint>();
		
		[field: UnityEngine.SerializeField]
		public CsSystem.Collections.Generic.List<uint> values { get; private set; } = new CsSystem.Collections.Generic.List<uint>();
		...
		static UInt32ArrayPropertyDifference()
		{
			if (Fox.Core.PropertyDifference.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("UInt32ArrayPropertyDifference", typeof(UInt32ArrayPropertyDifference), Fox.Core.PropertyDifference.ClassInfo, 0, null, 0);
