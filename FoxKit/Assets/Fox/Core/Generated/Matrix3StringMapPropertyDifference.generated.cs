...
namespace Fox.Core
{
	...
	public partial class Matrix3StringMapPropertyDifference : Fox.Core.PropertyDifference
	{
		...
		public Fox.StringMap<Fox.Matrix3x3> originalValues { get; private set; } = new Fox.StringMap<Fox.Matrix3x3>();
		
		[field: UnityEngine.SerializeField]
		public Fox.StringMap<Fox.Matrix3x3> values { get; private set; } = new Fox.StringMap<Fox.Matrix3x3>();
		...
		static Matrix3StringMapPropertyDifference()
		{
			if (Fox.Core.PropertyDifference.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("Matrix3StringMapPropertyDifference", typeof(Matrix3StringMapPropertyDifference), Fox.Core.PropertyDifference.ClassInfo, 0, null, 0);
		...
		public override void SetPropertyElement(string propertyName, string key, Fox.Core.Value value)
		{
			...
			{
				case "originalValues":
					this.originalValues[key] = value.GetValueAsMatrix3();
					return;
				case "values":
					this.values[key] = value.GetValueAsMatrix3();
					return;
				default:
