...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/FoxDataLinkCollectorDataBody")]
	public partial class FoxDataLinkCollectorDataBody : Fox.Core.DataBody
	{
		...
		static FoxDataLinkCollectorDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("FoxDataLinkCollectorDataBody", typeof(FoxDataLinkCollectorDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
