...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/ShapeDataBody")]
	public partial class ShapeDataBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static ShapeDataBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("ShapeDataBody", typeof(ShapeDataBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
