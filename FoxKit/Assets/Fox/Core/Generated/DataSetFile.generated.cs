...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/DataSetFile")]
	public partial class DataSetFile : Fox.Core.File
	{
		...
		static DataSetFile()
		{
			if (Fox.Core.File.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("DataSetFile", typeof(DataSetFile), Fox.Core.File.ClassInfo, 0, null, 0);
