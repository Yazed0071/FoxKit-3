...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/EntityClassDictionary")]
	public partial class EntityClassDictionary : Fox.Core.Entity
	{
		...
		static EntityClassDictionary()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("EntityClassDictionary", typeof(EntityClassDictionary), Fox.Core.Entity.ClassInfo, 0, null, 0);
