...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/PropertyDifference")]
	public partial class PropertyDifference : Fox.Core.Entity
	{
		// ClassInfos
		...
		static PropertyDifference()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("PropertyDifference", typeof(PropertyDifference), Fox.Core.Entity.ClassInfo, 0, null, 0);
