...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/ComponentSet")]
	public partial class ComponentSet : Fox.Core.Entity
	{
		// ClassInfos
		...
		static ComponentSet()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("ComponentSet", typeof(ComponentSet), Fox.Core.Entity.ClassInfo, 0, null, 0);
