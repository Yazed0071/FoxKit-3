...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/ConnectPointFile")]
	public partial class ConnectPointFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static ConnectPointFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("ConnectPointFile", typeof(ConnectPointFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
