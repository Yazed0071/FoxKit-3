...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/TransformComponentSet")]
	public partial class TransformComponentSet : Fox.Core.ComponentSet
	{
		// ClassInfos
		...
		static TransformComponentSet()
		{
			if (Fox.Core.ComponentSet.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TransformComponentSet", typeof(TransformComponentSet), Fox.Core.ComponentSet.ClassInfo, 0, null, 0);
