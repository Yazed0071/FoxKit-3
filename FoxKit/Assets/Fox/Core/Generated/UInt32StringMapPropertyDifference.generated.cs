...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/UInt32StringMapPropertyDifference")]
	public partial class UInt32StringMapPropertyDifference : Fox.Core.PropertyDifference
	{
		// Properties
		[field: UnityEngine.SerializeField]
		public Fox.StringMap<uint> originalValues { get; private set; } = new Fox.StringMap<uint>();
		
		[field: UnityEngine.SerializeField]
		public Fox.StringMap<uint> values { get; private set; } = new Fox.StringMap<uint>();
		...
		static UInt32StringMapPropertyDifference()
		{
			if (Fox.Core.PropertyDifference.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("UInt32StringMapPropertyDifference", typeof(UInt32StringMapPropertyDifference), Fox.Core.PropertyDifference.ClassInfo, 0, null, 0);
		...
		public override void SetPropertyElement(string propertyName, string key, Fox.Core.Value value)
		{
			...
			{
				case "originalValues":
					this.originalValues[key] = value.GetValueAsUInt32();
					return;
				case "values":
					this.values[key] = value.GetValueAsUInt32();
					return;
				default:
