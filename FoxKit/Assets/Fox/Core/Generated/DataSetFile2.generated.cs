...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/DataSetFile2")]
	public partial class DataSetFile2 : Fox.Core.EntityFile
	{
		// Properties
		public Fox.Core.DataSet dataSet { get => dataSet_Get(); }
		private partial Fox.Core.DataSet dataSet_Get();
		...
		static DataSetFile2()
		{
			if (Fox.Core.EntityFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("DataSetFile2", typeof(DataSetFile2), Fox.Core.EntityFile.ClassInfo, 0, null, 0);
