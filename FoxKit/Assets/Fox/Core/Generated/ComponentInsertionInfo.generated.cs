...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/ComponentInsertionInfo")]
	public partial class ComponentInsertionInfo : Fox.Core.Entity
	{
		// ClassInfos
		...
		static ComponentInsertionInfo()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("ComponentInsertionInfo", typeof(ComponentInsertionInfo), Fox.Core.Entity.ClassInfo, 0, null, 0);
