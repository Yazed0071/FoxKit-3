...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/EditableBlockPackageBase")]
	public partial class EditableBlockPackageBase : Fox.Core.Entity
	{
		// ClassInfos
		...
		static EditableBlockPackageBase()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("EditableBlockPackageBase", typeof(EditableBlockPackageBase), Fox.Core.Entity.ClassInfo, 0, null, 0);
