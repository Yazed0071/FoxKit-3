...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/Int8Entity")]
	public partial class Int8Entity : Fox.Core.PropertyValueEntity
	{
		...
		static Int8Entity()
		{
			if (Fox.Core.PropertyValueEntity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("Int8Entity", typeof(Int8Entity), Fox.Core.PropertyValueEntity.ClassInfo, 0, null, 0);
