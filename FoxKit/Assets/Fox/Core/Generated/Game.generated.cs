...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/Game")]
	public partial class Game : Fox.Core.Actor
	{
		...
		static Game()
		{
			if (Fox.Core.Actor.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("Game", typeof(Game), Fox.Core.Actor.ClassInfo, 0, null, 0);
		...
		public override Fox.Core.Value GetProperty(string propertyName)
		{
			switch (propertyName)
			{
				case "bucketCollector":
					return new Fox.Core.Value(bucketCollector);
				default:
