...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/Matrix4ArrayPropertyDifference")]
	public partial class Matrix4ArrayPropertyDifference : Fox.Core.PropertyDifference
	{
		// Properties
		[field: UnityEngine.SerializeField]
		public CsSystem.Collections.Generic.List<UnityEngine.Matrix4x4> originalValues { get; private set; } = new CsSystem.Collections.Generic.List<UnityEngine.Matrix4x4>();
		
		[field: UnityEngine.SerializeField]
		public CsSystem.Collections.Generic.List<UnityEngine.Matrix4x4> values { get; private set; } = new CsSystem.Collections.Generic.List<UnityEngine.Matrix4x4>();
		...
		static Matrix4ArrayPropertyDifference()
		{
			if (Fox.Core.PropertyDifference.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("Matrix4ArrayPropertyDifference", typeof(Matrix4ArrayPropertyDifference), Fox.Core.PropertyDifference.ClassInfo, 0, null, 0);
