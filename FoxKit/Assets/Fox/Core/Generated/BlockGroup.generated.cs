...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/BlockGroup")]
	public partial class BlockGroup : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static BlockGroup()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("BlockGroup", typeof(BlockGroup), Fox.Core.DataBody.ClassInfo, 0, null, 0);
