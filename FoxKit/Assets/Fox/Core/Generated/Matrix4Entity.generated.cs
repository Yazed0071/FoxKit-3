...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/Matrix4Entity")]
	public partial class Matrix4Entity : Fox.Core.PropertyValueEntity
	{
		...
		static Matrix4Entity()
		{
			if (Fox.Core.PropertyValueEntity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("Matrix4Entity", typeof(Matrix4Entity), Fox.Core.PropertyValueEntity.ClassInfo, 0, null, 0);
