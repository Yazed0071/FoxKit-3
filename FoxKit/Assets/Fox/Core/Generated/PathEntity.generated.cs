...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/PathEntity")]
	public partial class PathEntity : Fox.Core.PropertyValueEntity
	{
		// Properties
		[field: UnityEngine.SerializeField]
		protected Fox.Path value { get; set; }
		...
		static PathEntity()
		{
			if (Fox.Core.PropertyValueEntity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("PathEntity", typeof(PathEntity), Fox.Core.PropertyValueEntity.ClassInfo, 0, null, 0);
