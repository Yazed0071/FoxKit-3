...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/BlockScriptBody")]
	public partial class BlockScriptBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static BlockScriptBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("BlockScriptBody", typeof(BlockScriptBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
