...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/PathMapper")]
	public partial class PathMapper : Fox.Core.Entity
	{
		// ClassInfos
		...
		static PathMapper()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("PathMapper", typeof(PathMapper), Fox.Core.Entity.ClassInfo, 0, null, 0);
