	...
	public partial class Int64Entity : Fox.Core.PropertyValueEntity
	{
		...
		static Int64Entity()
		{
			if (Fox.Core.PropertyValueEntity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("Int64Entity", typeof(Int64Entity), Fox.Core.PropertyValueEntity.ClassInfo, 0, null, 0);
			classInfo.AddStaticProperty(new Fox.Core.PropertyInfo("value", Fox.Core.PropertyInfo.PropertyType.Int64, 56, 1, Fox.Core.PropertyInfo.ContainerType.StaticArray, Fox.Core.PropertyInfo.PropertyExport.Never, Fox.Core.PropertyInfo.PropertyExport.Never, null, null, Fox.Core.PropertyInfo.PropertyStorage.Instance, Fox.Core.PropertyInfo.BackingType.Field));
		...
		public override void SetProperty(string propertyName, Fox.Core.Value value)
		{
			...
			{
				case "value":
					this.value = value.GetValueAsInt64();
					return;
				default:
