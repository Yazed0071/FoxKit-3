...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/Scene")]
	public partial class Scene : Fox.Core.Actor
	{
		// ClassInfos
		...
		static Scene()
		{
			if (Fox.Core.Actor.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("Scene", typeof(Scene), Fox.Core.Actor.ClassInfo, 0, null, 0);
