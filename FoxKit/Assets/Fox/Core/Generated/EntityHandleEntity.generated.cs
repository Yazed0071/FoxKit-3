...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/EntityHandleEntity")]
	public partial class EntityHandleEntity : Fox.Core.PropertyValueEntity
	{
		...
		static EntityHandleEntity()
		{
			if (Fox.Core.PropertyValueEntity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("EntityHandleEntity", typeof(EntityHandleEntity), Fox.Core.PropertyValueEntity.ClassInfo, 0, null, 0);
