...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/WideVector3Entity")]
	public partial class WideVector3Entity : Fox.Core.PropertyValueEntity
	{
		// Properties
		[field: UnityEngine.SerializeField]
		protected Fox.WideVector3 value { get; set; }
		...
		static WideVector3Entity()
		{
			if (Fox.Core.PropertyValueEntity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("WideVector3Entity", typeof(WideVector3Entity), Fox.Core.PropertyValueEntity.ClassInfo, 0, null, 0);
