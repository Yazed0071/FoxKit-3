...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/StageBlockFile")]
	public partial class StageBlockFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static StageBlockFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("StageBlockFile", typeof(StageBlockFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
