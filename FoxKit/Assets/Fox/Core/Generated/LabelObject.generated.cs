...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/LabelObject")]
	public partial class LabelObject : Fox.Core.Entity
	{
		// ClassInfos
		...
		static LabelObject()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("LabelObject", typeof(LabelObject), Fox.Core.Entity.ClassInfo, 0, null, 0);
