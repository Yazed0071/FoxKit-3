...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/CallbackProcedureDataBody")]
	public partial class CallbackProcedureDataBody : Fox.Core.DataBody
	{
		...
		static CallbackProcedureDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("CallbackProcedureDataBody", typeof(CallbackProcedureDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
