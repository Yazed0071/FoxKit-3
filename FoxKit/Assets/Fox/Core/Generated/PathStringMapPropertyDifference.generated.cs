...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/PathStringMapPropertyDifference")]
	public partial class PathStringMapPropertyDifference : Fox.Core.PropertyDifference
	{
		// Properties
		[field: UnityEngine.SerializeField]
		public Fox.StringMap<Fox.Path> originalValues { get; private set; } = new Fox.StringMap<Fox.Path>();
		
		[field: UnityEngine.SerializeField]
		public Fox.StringMap<Fox.Path> values { get; private set; } = new Fox.StringMap<Fox.Path>();
		...
		static PathStringMapPropertyDifference()
		{
			if (Fox.Core.PropertyDifference.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("PathStringMapPropertyDifference", typeof(PathStringMapPropertyDifference), Fox.Core.PropertyDifference.ClassInfo, 0, null, 0);
		...
		public override void SetPropertyElement(string propertyName, string key, Fox.Core.Value value)
		{
			...
			{
				case "originalValues":
					this.originalValues[key] = value.GetValueAsPath();
					return;
				case "values":
					this.values[key] = value.GetValueAsPath();
					return;
				default:
