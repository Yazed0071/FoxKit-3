...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/Application")]
	public partial class Application : Fox.Core.Actor
	{
		// ClassInfos
		...
		static Application()
		{
			if (Fox.Core.Actor.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("Application", typeof(Application), Fox.Core.Actor.ClassInfo, 0, null, 0);
