...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/QuatEntity")]
	public partial class QuatEntity : Fox.Core.PropertyValueEntity
	{
		// Properties
		[field: UnityEngine.SerializeField]
		protected UnityEngine.Quaternion value { get; set; }
		...
		public override void SetProperty(string propertyName, Fox.Core.Value value)
		{
			...
			{
				case "value":
					this.value = value.GetValueAsQuat();
					return;
				default:
