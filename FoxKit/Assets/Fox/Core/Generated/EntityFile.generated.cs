...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/EntityFile")]
	public partial class EntityFile : Fox.Core.File
	{
		// ClassInfos
		...
		static EntityFile()
		{
			if (Fox.Core.File.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("EntityFile", typeof(EntityFile), Fox.Core.File.ClassInfo, 0, null, 0);
