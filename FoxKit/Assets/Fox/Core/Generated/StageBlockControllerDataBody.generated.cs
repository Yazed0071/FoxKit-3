...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/StageBlockControllerDataBody")]
	public partial class StageBlockControllerDataBody : Fox.Core.DataBody
	{
		...
		static StageBlockControllerDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("StageBlockControllerDataBody", typeof(StageBlockControllerDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
