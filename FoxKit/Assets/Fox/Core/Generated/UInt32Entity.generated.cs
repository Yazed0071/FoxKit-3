...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/UInt32Entity")]
	public partial class UInt32Entity : Fox.Core.PropertyValueEntity
	{
		...
		static UInt32Entity()
		{
			if (Fox.Core.PropertyValueEntity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("UInt32Entity", typeof(UInt32Entity), Fox.Core.PropertyValueEntity.ClassInfo, 0, null, 0);
