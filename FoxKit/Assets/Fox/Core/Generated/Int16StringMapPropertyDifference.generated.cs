...
namespace Fox.Core
{
	...
	public partial class Int16StringMapPropertyDifference : Fox.Core.PropertyDifference
	{
		...
		public Fox.StringMap<short> originalValues { get; private set; } = new Fox.StringMap<short>();
		
		[field: UnityEngine.SerializeField]
		public Fox.StringMap<short> values { get; private set; } = new Fox.StringMap<short>();
		...
		static Int16StringMapPropertyDifference()
		{
			if (Fox.Core.PropertyDifference.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("Int16StringMapPropertyDifference", typeof(Int16StringMapPropertyDifference), Fox.Core.PropertyDifference.ClassInfo, 0, null, 0);
		...
		public override void SetPropertyElement(string propertyName, string key, Fox.Core.Value value)
		{
			...
			{
				case "originalValues":
					this.originalValues[key] = value.GetValueAsInt16();
					return;
				case "values":
					this.values[key] = value.GetValueAsInt16();
					return;
				default:
