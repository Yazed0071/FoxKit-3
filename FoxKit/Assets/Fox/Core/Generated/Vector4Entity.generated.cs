...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/Vector4Entity")]
	public partial class Vector4Entity : Fox.Core.PropertyValueEntity
	{
		...
		static Vector4Entity()
		{
			if (Fox.Core.PropertyValueEntity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("Vector4Entity", typeof(Vector4Entity), Fox.Core.PropertyValueEntity.ClassInfo, 0, null, 0);
