...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/MaterialBody")]
	public partial class MaterialBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static MaterialBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("MaterialBody", typeof(MaterialBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
