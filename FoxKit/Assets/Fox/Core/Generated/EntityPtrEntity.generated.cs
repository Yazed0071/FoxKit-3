...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/EntityPtrEntity")]
	public partial class EntityPtrEntity : Fox.Core.PropertyValueEntity
	{
		...
		static EntityPtrEntity()
		{
			if (Fox.Core.PropertyValueEntity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("EntityPtrEntity", typeof(EntityPtrEntity), Fox.Core.PropertyValueEntity.ClassInfo, 0, null, 0);
