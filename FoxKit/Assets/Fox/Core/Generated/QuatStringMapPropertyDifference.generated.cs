...
namespace Fox.Core
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("FoxCore/QuatStringMapPropertyDifference")]
	public partial class QuatStringMapPropertyDifference : Fox.Core.PropertyDifference
	{
		// Properties
		[field: UnityEngine.SerializeField]
		public Fox.StringMap<UnityEngine.Quaternion> originalValues { get; private set; } = new Fox.StringMap<UnityEngine.Quaternion>();
		
		[field: UnityEngine.SerializeField]
		public Fox.StringMap<UnityEngine.Quaternion> values { get; private set; } = new Fox.StringMap<UnityEngine.Quaternion>();
		...
		static QuatStringMapPropertyDifference()
		{
			if (Fox.Core.PropertyDifference.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("QuatStringMapPropertyDifference", typeof(QuatStringMapPropertyDifference), Fox.Core.PropertyDifference.ClassInfo, 0, null, 0);
		...
		public override void SetPropertyElement(string propertyName, string key, Fox.Core.Value value)
		{
			...
			{
				case "originalValues":
					this.originalValues[key] = value.GetValueAsQuat();
					return;
				case "values":
					this.values[key] = value.GetValueAsQuat();
					return;
				default:
