...
namespace Fox.Core
{
    ...
    public class DynamicProperty_DynamicArray_Path : DynamicProperty
    {
        ...
        public override void SetElement(int index, Value value) => SerializedField[index] = value.GetValueAsPath();
        public override void AddElement(int index, Value value) => SerializedField.Insert(index, value.GetValueAsPath());
