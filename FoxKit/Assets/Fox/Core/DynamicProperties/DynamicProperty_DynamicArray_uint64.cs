...
namespace Fox.Core
{
    ...
    public class DynamicProperty_DynamicArray_uint64 : DynamicProperty
    {
        ...
        public override void SetElement(int index, Value value) => SerializedField[index] = value.GetValueAsUInt64();
        public override void AddElement(int index, Value value) => SerializedField.Insert(index, value.GetValueAsUInt64());
