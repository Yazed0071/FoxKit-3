...
namespace Fox.Core
{
    ...
    public class DynamicProperty_DynamicArray_String : DynamicProperty
    {
        ...
        public override void SetElement(int index, Value value) => SerializedField[index] = value.GetValueAsString();
        public override void AddElement(int index, Value value) => SerializedField.Insert(index, value.GetValueAsString());
