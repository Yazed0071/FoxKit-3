...
namespace Fox.Core
{
    ...
    public class DynamicProperty_DynamicArray_float : DynamicProperty
    {
        ...
        public override void SetElement(int index, Value value) => SerializedField[index] = value.GetValueAsFloat();
        public override void AddElement(int index, Value value) => SerializedField.Insert(index, value.GetValueAsFloat());
