...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPlugin2DFrontmost")]
	public partial class GrPlugin2DFrontmost : Fox.Gr.GrPlugin2D
	{
		// ClassInfos
		...
		static GrPlugin2DFrontmost()
		{
			if (Fox.Gr.GrPlugin2D.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPlugin2DFrontmost", typeof(GrPlugin2DFrontmost), Fox.Gr.GrPlugin2D.ClassInfo, 0, null, 0);
