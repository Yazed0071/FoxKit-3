...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginRawDecal")]
	public partial class GrPluginRawDecal : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginRawDecal()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginRawDecal", typeof(GrPluginRawDecal), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
