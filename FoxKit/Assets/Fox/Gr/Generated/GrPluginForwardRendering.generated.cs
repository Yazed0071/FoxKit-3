...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginForwardRendering")]
	public partial class GrPluginForwardRendering : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginForwardRendering()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginForwardRendering", typeof(GrPluginForwardRendering), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
