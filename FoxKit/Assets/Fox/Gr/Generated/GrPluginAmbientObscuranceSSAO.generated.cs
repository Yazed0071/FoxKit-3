...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginAmbientObscuranceSSAO")]
	public partial class GrPluginAmbientObscuranceSSAO : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginAmbientObscuranceSSAO()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginAmbientObscuranceSSAO", typeof(GrPluginAmbientObscuranceSSAO), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
