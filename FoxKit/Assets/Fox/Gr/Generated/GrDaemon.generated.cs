...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrDaemon")]
	public partial class GrDaemon : Fox.Core.Actor
	{
		// ClassInfos
		...
		static GrDaemon()
		{
			if (Fox.Core.Actor.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrDaemon", typeof(GrDaemon), Fox.Core.Actor.ClassInfo, 0, null, 0);
