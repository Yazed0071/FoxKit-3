...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginClone")]
	public partial class GrPluginClone : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginClone()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginClone", typeof(GrPluginClone), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
