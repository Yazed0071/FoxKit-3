...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginSunlight")]
	public partial class GrPluginSunlight : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginSunlight()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginSunlight", typeof(GrPluginSunlight), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
