...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginScreenSpaceAmbientOcclusion")]
	public partial class GrPluginScreenSpaceAmbientOcclusion : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginScreenSpaceAmbientOcclusion()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginScreenSpaceAmbientOcclusion", typeof(GrPluginScreenSpaceAmbientOcclusion), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
