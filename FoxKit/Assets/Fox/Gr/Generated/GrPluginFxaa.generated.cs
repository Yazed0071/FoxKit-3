...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginFxaa")]
	public partial class GrPluginFxaa : Fox.Gr.GrRenderPlugin
	{
		...
		static GrPluginFxaa()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginFxaa", typeof(GrPluginFxaa), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
