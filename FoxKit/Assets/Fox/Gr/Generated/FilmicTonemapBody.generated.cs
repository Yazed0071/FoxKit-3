...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/FilmicTonemapBody")]
	public partial class FilmicTonemapBody : Fox.Core.DataBody
	{
		...
		static FilmicTonemapBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("FilmicTonemapBody", typeof(FilmicTonemapBody), Fox.Core.DataBody.ClassInfo, 0, null, 1);
