...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/FmdlFile")]
	public partial class FmdlFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static FmdlFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("FmdlFile", typeof(FmdlFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
