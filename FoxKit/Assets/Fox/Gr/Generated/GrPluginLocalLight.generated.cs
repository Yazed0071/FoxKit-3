...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginLocalLight")]
	public partial class GrPluginLocalLight : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginLocalLight()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginLocalLight", typeof(GrPluginLocalLight), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 2);
