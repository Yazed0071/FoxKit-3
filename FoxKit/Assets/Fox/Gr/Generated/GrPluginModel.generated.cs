...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginModel")]
	public partial class GrPluginModel : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginModel()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginModel", typeof(GrPluginModel), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
