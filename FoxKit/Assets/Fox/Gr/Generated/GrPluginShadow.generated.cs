...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginShadow")]
	public partial class GrPluginShadow : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginShadow()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginShadow", typeof(GrPluginShadow), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
