...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/TerrainTileFile")]
	public partial class TerrainTileFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static TerrainTileFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TerrainTileFile", typeof(TerrainTileFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
