...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrGraphicsSettingManager")]
	public partial class GrGraphicsSettingManager : Fox.Core.Entity
	{
		// ClassInfos
		...
		static GrGraphicsSettingManager()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrGraphicsSettingManager", typeof(GrGraphicsSettingManager), Fox.Core.Entity.ClassInfo, 0, null, 0);
