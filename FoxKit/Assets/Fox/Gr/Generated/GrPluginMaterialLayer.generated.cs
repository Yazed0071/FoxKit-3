...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginMaterialLayer")]
	public partial class GrPluginMaterialLayer : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginMaterialLayer()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginMaterialLayer", typeof(GrPluginMaterialLayer), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
