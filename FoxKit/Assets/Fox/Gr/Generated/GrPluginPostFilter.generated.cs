...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginPostFilter")]
	public partial class GrPluginPostFilter : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginPostFilter()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginPostFilter", typeof(GrPluginPostFilter), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
