...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginPrimitive")]
	public partial class GrPluginPrimitive : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginPrimitive()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginPrimitive", typeof(GrPluginPrimitive), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
