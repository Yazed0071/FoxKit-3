...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPlugin2DShrink")]
	public partial class GrPlugin2DShrink : Fox.Gr.GrPlugin2D
	{
		...
		static GrPlugin2DShrink()
		{
			if (Fox.Gr.GrPlugin2D.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPlugin2DShrink", typeof(GrPlugin2DShrink), Fox.Gr.GrPlugin2D.ClassInfo, 0, null, 0);
