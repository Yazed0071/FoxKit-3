...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginPrimitiveUnfiltered")]
	public partial class GrPluginPrimitiveUnfiltered : Fox.Gr.GrPluginPrimitive
	{
		// ClassInfos
		...
		{
			if (Fox.Gr.GrPluginPrimitive.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginPrimitiveUnfiltered", typeof(GrPluginPrimitiveUnfiltered), Fox.Gr.GrPluginPrimitive.ClassInfo, 0, null, 0);
