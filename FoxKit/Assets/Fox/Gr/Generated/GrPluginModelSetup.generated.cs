...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginModelSetup")]
	public partial class GrPluginModelSetup : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginModelSetup()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginModelSetup", typeof(GrPluginModelSetup), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
