...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrViewport")]
	public partial class GrViewport : Fox.Core.Entity
	{
		// ClassInfos
		...
		static GrViewport()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrViewport", typeof(GrViewport), Fox.Core.Entity.ClassInfo, 0, null, 0);
