...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/TerrainFile")]
	public partial class TerrainFile : Fox.Core.RawFile
	{
		...
		static TerrainFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TerrainFile", typeof(TerrainFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
