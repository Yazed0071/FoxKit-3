...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginThermography")]
	public partial class GrPluginThermography : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginThermography()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginThermography", typeof(GrPluginThermography), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
