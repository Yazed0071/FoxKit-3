...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginWormhole")]
	public partial class GrPluginWormhole : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginWormhole()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginWormhole", typeof(GrPluginWormhole), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
