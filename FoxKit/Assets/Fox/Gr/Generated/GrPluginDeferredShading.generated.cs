...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginDeferredShading")]
	public partial class GrPluginDeferredShading : Fox.Gr.GrRenderPlugin
	{
		...
		static GrPluginDeferredShading()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginDeferredShading", typeof(GrPluginDeferredShading), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
