...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginSphericalHarmonics")]
	public partial class GrPluginSphericalHarmonics : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginSphericalHarmonics()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginSphericalHarmonics", typeof(GrPluginSphericalHarmonics), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
