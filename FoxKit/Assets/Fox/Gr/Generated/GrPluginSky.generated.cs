...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginSky")]
	public partial class GrPluginSky : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginSky()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginSky", typeof(GrPluginSky), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
