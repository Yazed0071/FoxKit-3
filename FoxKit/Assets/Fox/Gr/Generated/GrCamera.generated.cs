...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrCamera")]
	public partial class GrCamera : Fox.Core.Entity
	{
		// ClassInfos
		...
		static GrCamera()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrCamera", typeof(GrCamera), Fox.Core.Entity.ClassInfo, 0, null, 0);
