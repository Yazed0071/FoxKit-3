...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginPrecomputeSky")]
	public partial class GrPluginPrecomputeSky : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginPrecomputeSky()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginPrecomputeSky", typeof(GrPluginPrecomputeSky), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
