...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginDeferredGeometryDecal")]
	public partial class GrPluginDeferredGeometryDecal : Fox.Gr.GrPluginDeferredGeometryOpaque
	{
		// ClassInfos
		...
		static GrPluginDeferredGeometryDecal()
		{
			if (Fox.Gr.GrPluginDeferredGeometryOpaque.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginDeferredGeometryDecal", typeof(GrPluginDeferredGeometryDecal), Fox.Gr.GrPluginDeferredGeometryOpaque.ClassInfo, 0, null, 0);
