...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginViewCallback")]
	public partial class GrPluginViewCallback : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginViewCallback()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginViewCallback", typeof(GrPluginViewCallback), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
