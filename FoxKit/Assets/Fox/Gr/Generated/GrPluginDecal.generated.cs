...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginDecal")]
	public partial class GrPluginDecal : Fox.Gr.GrRenderPlugin
	{
		...
		static GrPluginDecal()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginDecal", typeof(GrPluginDecal), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
