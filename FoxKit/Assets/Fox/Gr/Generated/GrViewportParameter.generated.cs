...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrViewportParameter")]
	public partial class GrViewportParameter : Fox.Core.Entity
	{
		// ClassInfos
		...
		static GrViewportParameter()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrViewportParameter", typeof(GrViewportParameter), Fox.Core.Entity.ClassInfo, 0, null, 0);
