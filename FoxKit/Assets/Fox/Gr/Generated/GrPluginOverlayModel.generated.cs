...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginOverlayModel")]
	public partial class GrPluginOverlayModel : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginOverlayModel()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginOverlayModel", typeof(GrPluginOverlayModel), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
