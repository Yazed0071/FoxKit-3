...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginLightAccumulateLayer")]
	public partial class GrPluginLightAccumulateLayer : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginLightAccumulateLayer()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginLightAccumulateLayer", typeof(GrPluginLightAccumulateLayer), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
