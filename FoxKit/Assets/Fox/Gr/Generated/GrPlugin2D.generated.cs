...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPlugin2D")]
	public partial class GrPlugin2D : Fox.Gr.GrRenderPlugin
	{
		...
		static GrPlugin2D()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPlugin2D", typeof(GrPlugin2D), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
