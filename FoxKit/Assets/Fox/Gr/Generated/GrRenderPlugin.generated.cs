...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrRenderPlugin")]
	public partial class GrRenderPlugin : Fox.Core.Entity
	{
		// ClassInfos
		...
		static GrRenderPlugin()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrRenderPlugin", typeof(GrRenderPlugin), Fox.Core.Entity.ClassInfo, 0, null, 0);
