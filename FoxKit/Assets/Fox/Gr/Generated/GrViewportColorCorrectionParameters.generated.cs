...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrViewportColorCorrectionParameters")]
	public partial class GrViewportColorCorrectionParameters : Fox.Gr.GrViewportParameter
	{
		// ClassInfos
		...
		static GrViewportColorCorrectionParameters()
		{
			if (Fox.Gr.GrViewportParameter.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrViewportColorCorrectionParameters", typeof(GrViewportColorCorrectionParameters), Fox.Gr.GrViewportParameter.ClassInfo, 0, null, 0);
