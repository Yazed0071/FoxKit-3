...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginSeflShadowOfTerrain")]
	public partial class GrPluginSeflShadowOfTerrain : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginSeflShadowOfTerrain()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginSeflShadowOfTerrain", typeof(GrPluginSeflShadowOfTerrain), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
