...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginDeferredRendering")]
	public partial class GrPluginDeferredRendering : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginDeferredRendering()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginDeferredRendering", typeof(GrPluginDeferredRendering), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
