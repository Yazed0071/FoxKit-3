...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginOccluder")]
	public partial class GrPluginOccluder : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginOccluder()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginOccluder", typeof(GrPluginOccluder), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
