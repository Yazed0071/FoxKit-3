...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginSubSurfaceScatter")]
	public partial class GrPluginSubSurfaceScatter : Fox.Gr.GrRenderPlugin
	{
		// ClassInfos
		...
		static GrPluginSubSurfaceScatter()
		{
			if (Fox.Gr.GrRenderPlugin.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginSubSurfaceScatter", typeof(GrPluginSubSurfaceScatter), Fox.Gr.GrRenderPlugin.ClassInfo, 0, null, 0);
