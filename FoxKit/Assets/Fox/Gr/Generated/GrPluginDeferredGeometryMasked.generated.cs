...
namespace Fox.Gr
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Gr/GrPluginDeferredGeometryMasked")]
	public partial class GrPluginDeferredGeometryMasked : Fox.Gr.GrPluginDeferredGeometryOpaque
	{
		// ClassInfos
		...
		static GrPluginDeferredGeometryMasked()
		{
			if (Fox.Gr.GrPluginDeferredGeometryOpaque.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GrPluginDeferredGeometryMasked", typeof(GrPluginDeferredGeometryMasked), Fox.Gr.GrPluginDeferredGeometryOpaque.ClassInfo, 0, null, 0);
