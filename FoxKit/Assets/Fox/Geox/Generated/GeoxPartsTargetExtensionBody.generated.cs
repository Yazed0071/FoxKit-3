...
namespace Fox.Geox
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geox/GeoxPartsTargetExtensionBody")]
	public partial class GeoxPartsTargetExtensionBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static GeoxPartsTargetExtensionBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoxPartsTargetExtensionBody", typeof(GeoxPartsTargetExtensionBody), Fox.Core.DataBody.ClassInfo, 0, "Target", 0);
