...
namespace Fox.Geox
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geox/GeoxGeomSetLoader")]
	public partial class GeoxGeomSetLoader : Fox.Core.TransformData
	{
		...
		static GeoxGeomSetLoader()
		{
			if (Fox.Core.TransformData.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoxGeomSetLoader", typeof(GeoxGeomSetLoader), Fox.Core.TransformData.ClassInfo, 288, null, 0);
		...
		public override Fox.Core.Value GetProperty(string propertyName)
		{
			...
			{
				case "geomSetFile":
					return new Fox.Core.Value(geomSetFile);
				default:
