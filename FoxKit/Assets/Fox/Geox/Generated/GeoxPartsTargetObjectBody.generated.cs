...
namespace Fox.Geox
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geox/GeoxPartsTargetObjectBody")]
	public partial class GeoxPartsTargetObjectBody : Fox.Core.TransformDataBody
	{
		...
		static GeoxPartsTargetObjectBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoxPartsTargetObjectBody", typeof(GeoxPartsTargetObjectBody), Fox.Core.TransformDataBody.ClassInfo, 0, "Target", 0);
