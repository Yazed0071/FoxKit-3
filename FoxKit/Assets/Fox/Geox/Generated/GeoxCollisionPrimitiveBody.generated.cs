...
namespace Fox.Geox
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geox/GeoxCollisionPrimitiveBody")]
	public partial class GeoxCollisionPrimitiveBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static GeoxCollisionPrimitiveBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoxCollisionPrimitiveBody", typeof(GeoxCollisionPrimitiveBody), Fox.Core.TransformDataBody.ClassInfo, 0, "Geox", 0);
