...
namespace Fox.Geox
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geox/GeoxGeomSetLoaderBody")]
	public partial class GeoxGeomSetLoaderBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static GeoxGeomSetLoaderBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoxGeomSetLoaderBody", typeof(GeoxGeomSetLoaderBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
