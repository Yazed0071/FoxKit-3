...
namespace Fox.Geox
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geox/GeoxCollisionPyraidFreeShapeBody")]
	public partial class GeoxCollisionPyraidFreeShapeBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static GeoxCollisionPyraidFreeShapeBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoxCollisionPyraidFreeShapeBody", typeof(GeoxCollisionPyraidFreeShapeBody), Fox.Core.TransformDataBody.ClassInfo, 0, "Geox", 0);
