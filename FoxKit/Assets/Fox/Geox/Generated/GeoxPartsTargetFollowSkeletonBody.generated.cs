...
namespace Fox.Geox
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geox/GeoxPartsTargetFollowSkeletonBody")]
	public partial class GeoxPartsTargetFollowSkeletonBody : Fox.Core.DataBody
	{
		...
		static GeoxPartsTargetFollowSkeletonBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoxPartsTargetFollowSkeletonBody", typeof(GeoxPartsTargetFollowSkeletonBody), Fox.Core.DataBody.ClassInfo, 0, "Target", 0);
