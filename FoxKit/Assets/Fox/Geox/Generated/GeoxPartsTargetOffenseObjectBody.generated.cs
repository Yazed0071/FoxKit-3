...
namespace Fox.Geox
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geox/GeoxPartsTargetOffenseObjectBody")]
	public partial class GeoxPartsTargetOffenseObjectBody : Fox.Geox.GeoxPartsTargetObjectBody
	{
		...
		static GeoxPartsTargetOffenseObjectBody()
		{
			if (Fox.Geox.GeoxPartsTargetObjectBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoxPartsTargetOffenseObjectBody", typeof(GeoxPartsTargetOffenseObjectBody), Fox.Geox.GeoxPartsTargetObjectBody.ClassInfo, 0, "Target", 0);
