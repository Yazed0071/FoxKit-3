...
namespace Fox.Geox
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geox/GeoxDynamicPolygonBody")]
	public partial class GeoxDynamicPolygonBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static GeoxDynamicPolygonBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoxDynamicPolygonBody", typeof(GeoxDynamicPolygonBody), Fox.Core.TransformDataBody.ClassInfo, 0, "Geox", 0);
