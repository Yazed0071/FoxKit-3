...
namespace Fox.Geox
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geox/GeoxPath")]
	public partial class GeoxPath : Fox.Graphx.GraphxPathData
	{
		...
		static GeoxPath()
		{
			if (Fox.Graphx.GraphxPathData.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoxPath", typeof(GeoxPath), Fox.Graphx.GraphxPathData.ClassInfo, 304, "Geox", 0);
