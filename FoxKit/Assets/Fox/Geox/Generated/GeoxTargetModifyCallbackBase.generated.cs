...
namespace Fox.Geox
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geox/GeoxTargetModifyCallbackBase")]
	public partial class GeoxTargetModifyCallbackBase : Fox.Core.Entity
	{
		...
		static GeoxTargetModifyCallbackBase()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoxTargetModifyCallbackBase", typeof(GeoxTargetModifyCallbackBase), Fox.Core.Entity.ClassInfo, 0, "Geox", 0);
