...
namespace Fox.Geox
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geox/GeoxPathPackBody")]
	public partial class GeoxPathPackBody : Fox.Core.TransformDataBody
	{
		...
		static GeoxPathPackBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoxPathPackBody", typeof(GeoxPathPackBody), Fox.Core.TransformDataBody.ClassInfo, 0, "Path", 0);
