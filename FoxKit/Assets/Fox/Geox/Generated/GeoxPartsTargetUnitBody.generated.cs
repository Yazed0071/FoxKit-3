...
namespace Fox.Geox
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geox/GeoxPartsTargetUnitBody")]
	public partial class GeoxPartsTargetUnitBody : Fox.Core.DataBody
	{
		...
		static GeoxPartsTargetUnitBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoxPartsTargetUnitBody", typeof(GeoxPartsTargetUnitBody), Fox.Core.DataBody.ClassInfo, 0, "Target", 0);
