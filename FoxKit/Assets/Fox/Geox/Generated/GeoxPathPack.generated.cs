...
namespace Fox.Geox
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geox/GeoxPathPack")]
	public partial class GeoxPathPack : Fox.Core.TransformData
	{
		// Properties
		[field: UnityEngine.SerializeField]
		public Fox.Core.FilePtr pathFixedPackFile { get; set; }
		...
		static GeoxPathPack()
		{
			if (Fox.Core.TransformData.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoxPathPack", typeof(GeoxPathPack), Fox.Core.TransformData.ClassInfo, 288, "Path", 0);
		...
		public override Fox.Core.Value GetProperty(string propertyName)
		{
			switch (propertyName)
			{
				case "pathFixedPackFile":
					return new Fox.Core.Value(pathFixedPackFile);
				default:
		...
		public override void SetProperty(string propertyName, Fox.Core.Value value)
		{
			...
			{
				case "pathFixedPackFile":
					this.pathFixedPackFile = value.GetValueAsFilePtr();
					return;
				default:
