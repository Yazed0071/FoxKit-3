...
namespace Fox.Geox
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geox/GeoxTextureMaterialRegisterBody")]
	public partial class GeoxTextureMaterialRegisterBody : Fox.Core.DataBody
	{
		...
		static GeoxTextureMaterialRegisterBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoxTextureMaterialRegisterBody", typeof(GeoxTextureMaterialRegisterBody), Fox.Core.DataBody.ClassInfo, 0, "Geox", 0);
