...
namespace Fox.Fx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Fx/FxLocatorArrayDataBody")]
	public partial class FxLocatorArrayDataBody : Fox.Core.TransformDataBody
	{
		...
		static FxLocatorArrayDataBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("FxLocatorArrayDataBody", typeof(FxLocatorArrayDataBody), Fox.Core.TransformDataBody.ClassInfo, 0, "Fx", 0);
