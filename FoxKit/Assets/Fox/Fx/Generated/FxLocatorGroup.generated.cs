...
namespace Fox.Fx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Fx/FxLocatorGroup")]
	public partial class FxLocatorGroup : Fox.Core.TransformData
	{
		...
		static FxLocatorGroup()
		{
			if (Fox.Core.TransformData.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("FxLocatorGroup", typeof(FxLocatorGroup), Fox.Core.TransformData.ClassInfo, 272, "Fx", 1);
		...
		public override Fox.Core.Value GetProperty(string propertyName)
		{
			switch (propertyName)
			{
				case "groupInstanceName":
					return new Fox.Core.Value(groupInstanceName);
				default:
