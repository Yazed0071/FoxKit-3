...
namespace Fox.Fx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Fx/FxVfxBinaryFile")]
	public partial class FxVfxBinaryFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static FxVfxBinaryFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("FxVfxBinaryFile", typeof(FxVfxBinaryFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
