...
namespace Fox.Fx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Fx/FxLocator")]
	public partial class FxLocator : Fox.Core.TransformDataBody
	{
		...
		static FxLocator()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("FxLocator", typeof(FxLocator), Fox.Core.TransformDataBody.ClassInfo, 0, "Fx", 0);
