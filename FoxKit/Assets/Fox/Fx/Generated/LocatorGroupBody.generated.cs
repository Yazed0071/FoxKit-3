...
namespace Fox.Fx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Fx/LocatorGroupBody")]
	public partial class LocatorGroupBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static LocatorGroupBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("LocatorGroupBody", typeof(LocatorGroupBody), Fox.Core.TransformDataBody.ClassInfo, 0, "Fx", 0);
