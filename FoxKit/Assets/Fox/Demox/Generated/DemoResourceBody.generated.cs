...
namespace Fox.Demox
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Demox/DemoResourceBody")]
	public partial class DemoResourceBody : Fox.Core.DataBody
	{
		...
		static DemoResourceBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("DemoResourceBody", typeof(DemoResourceBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
