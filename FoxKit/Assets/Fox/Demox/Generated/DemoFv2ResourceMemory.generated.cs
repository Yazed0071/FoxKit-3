	...
	public partial class DemoFv2ResourceMemory : Fox.Core.DataElement
	{
		...
		static DemoFv2ResourceMemory()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("DemoFv2ResourceMemory", typeof(DemoFv2ResourceMemory), Fox.Core.DataElement.ClassInfo, 0, null, 0);
		...
		public override Fox.Core.Value GetProperty(string propertyName)
		{
			...
			{
				case "resourceSize":
					return new Fox.Core.Value(resourceSize);
				default:
