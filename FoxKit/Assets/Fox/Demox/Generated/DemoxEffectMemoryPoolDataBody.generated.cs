...
namespace Fox.Demox
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Demox/DemoxEffectMemoryPoolDataBody")]
	public partial class DemoxEffectMemoryPoolDataBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static DemoxEffectMemoryPoolDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("DemoxEffectMemoryPoolDataBody", typeof(DemoxEffectMemoryPoolDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
