...
namespace Fox.Demox
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Demox/DemoStreamAnimationBody")]
	public partial class DemoStreamAnimationBody : Fox.Core.DataBody
	{
		...
		static DemoStreamAnimationBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("DemoStreamAnimationBody", typeof(DemoStreamAnimationBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
