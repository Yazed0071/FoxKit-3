...
namespace Fox.Demo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Demo/DemoBlockPositionSetterBody")]
	public partial class DemoBlockPositionSetterBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static DemoBlockPositionSetterBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("DemoBlockPositionSetterBody", typeof(DemoBlockPositionSetterBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
