...
namespace Fox.Demo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Demo/BaseLocatorBody")]
	public partial class BaseLocatorBody : Fox.Core.TransformDataBody
	{
		...
		static BaseLocatorBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("BaseLocatorBody", typeof(BaseLocatorBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
