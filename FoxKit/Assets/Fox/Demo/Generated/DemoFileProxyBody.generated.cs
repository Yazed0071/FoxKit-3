...
namespace Fox.Demo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Demo/DemoFileProxyBody")]
	public partial class DemoFileProxyBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static DemoFileProxyBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("DemoFileProxyBody", typeof(DemoFileProxyBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
