...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoSearchDynamic")]
	public partial class GeoSearchDynamic : Fox.Geo.GeoSearchObject
	{
		// Properties
		[field: UnityEngine.SerializeField]
		protected Fox.Core.Entity collisionObject { get; set; }
		...
		static GeoSearchDynamic()
		{
			if (Fox.Geo.GeoSearchObject.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoSearchDynamic", typeof(GeoSearchDynamic), Fox.Geo.GeoSearchObject.ClassInfo, 0, null, 0);
		...
		public override Fox.Core.Value GetProperty(string propertyName)
		{
			switch (propertyName)
			{
				case "collisionObject":
					return new Fox.Core.Value(collisionObject);
				default:
