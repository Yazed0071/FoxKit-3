...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoCollisionTerrainMap")]
	public partial class GeoCollisionTerrainMap : Fox.Core.Entity
	{
		// ClassInfos
		...
		static GeoCollisionTerrainMap()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoCollisionTerrainMap", typeof(GeoCollisionTerrainMap), Fox.Core.Entity.ClassInfo, 0, "Collision", 0);
