...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/TargetExtensionData")]
	public partial class TargetExtensionData : Fox.Core.Entity
	{
		// ClassInfos
		...
		static TargetExtensionData()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TargetExtensionData", typeof(TargetExtensionData), Fox.Core.Entity.ClassInfo, 0, null, 0);
