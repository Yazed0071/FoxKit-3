...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoGeomFile")]
	public partial class GeoGeomFile : Fox.Core.RawFile
	{
		...
		static GeoGeomFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoGeomFile", typeof(GeoGeomFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
