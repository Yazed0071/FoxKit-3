...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/CollisionSkeletonCreater")]
	public partial class CollisionSkeletonCreater : Fox.Core.Entity
	{
		// ClassInfos
		...
		static CollisionSkeletonCreater()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("CollisionSkeletonCreater", typeof(CollisionSkeletonCreater), Fox.Core.Entity.ClassInfo, 0, "Collision", 0);
