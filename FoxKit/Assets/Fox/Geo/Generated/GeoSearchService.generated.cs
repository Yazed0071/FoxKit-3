...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoSearchService")]
	public partial class GeoSearchService : Fox.Core.Entity
	{
		...
		static GeoSearchService()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoSearchService", typeof(GeoSearchService), Fox.Core.Entity.ClassInfo, 0, null, 0);
