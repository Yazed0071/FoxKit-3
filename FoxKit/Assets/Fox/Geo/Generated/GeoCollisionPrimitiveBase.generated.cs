...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoCollisionPrimitiveBase")]
	public partial class GeoCollisionPrimitiveBase : Fox.Geo.CollisionObject
	{
		// ClassInfos
		...
		static GeoCollisionPrimitiveBase()
		{
			if (Fox.Geo.CollisionObject.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoCollisionPrimitiveBase", typeof(GeoCollisionPrimitiveBase), Fox.Geo.CollisionObject.ClassInfo, 0, "Collision", 0);
