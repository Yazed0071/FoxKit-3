...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoCollisionCircle")]
	public partial class GeoCollisionCircle : Fox.Geo.GeoCollisionPrimitiveBase
	{
		// ClassInfos
		...
		static GeoCollisionCircle()
		{
			if (Fox.Geo.GeoCollisionPrimitiveBase.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoCollisionCircle", typeof(GeoCollisionCircle), Fox.Geo.GeoCollisionPrimitiveBase.ClassInfo, 0, "Collision", 0);
