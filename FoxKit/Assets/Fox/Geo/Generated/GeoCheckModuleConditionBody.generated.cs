...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoCheckModuleConditionBody")]
	public partial class GeoCheckModuleConditionBody : Fox.Geo.GeoTrapConditionBody
	{
		// ClassInfos
		...
		static GeoCheckModuleConditionBody()
		{
			if (Fox.Geo.GeoTrapConditionBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoCheckModuleConditionBody", typeof(GeoCheckModuleConditionBody), Fox.Geo.GeoTrapConditionBody.ClassInfo, 0, "Trap", 0);
