...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoMaterialCache")]
	public partial class GeoMaterialCache : Fox.Core.Entity
	{
		...
		static GeoMaterialCache()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoMaterialCache", typeof(GeoMaterialCache), Fox.Core.Entity.ClassInfo, 0, null, 0);
