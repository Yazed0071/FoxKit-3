...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoTrapGeomHeader")]
	public partial class GeoTrapGeomHeader : Fox.Core.Entity
	{
		// ClassInfos
		...
		static GeoTrapGeomHeader()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoTrapGeomHeader", typeof(GeoTrapGeomHeader), Fox.Core.Entity.ClassInfo, 0, "Trap", 0);
