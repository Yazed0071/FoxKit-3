...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/MaterialInfoBase")]
	public partial class MaterialInfoBase : Fox.Core.Entity
	{
		// ClassInfos
		...
		static MaterialInfoBase()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("MaterialInfoBase", typeof(MaterialInfoBase), Fox.Core.Entity.ClassInfo, 0, null, 0);
