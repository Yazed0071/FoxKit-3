...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoTrapExecScriptConditionBody")]
	public partial class GeoTrapExecScriptConditionBody : Fox.Geo.GeoCheckModuleConditionBody
	{
		...
		static GeoTrapExecScriptConditionBody()
		{
			if (Fox.Geo.GeoCheckModuleConditionBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoTrapExecScriptConditionBody", typeof(GeoTrapExecScriptConditionBody), Fox.Geo.GeoCheckModuleConditionBody.ClassInfo, 0, "Trap", 0);
