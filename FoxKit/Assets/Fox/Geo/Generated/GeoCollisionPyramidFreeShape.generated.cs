...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoCollisionPyramidFreeShape")]
	public partial class GeoCollisionPyramidFreeShape : Fox.Geo.CollisionObject
	{
		// ClassInfos
		...
		static GeoCollisionPyramidFreeShape()
		{
			if (Fox.Geo.CollisionObject.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoCollisionPyramidFreeShape", typeof(GeoCollisionPyramidFreeShape), Fox.Geo.CollisionObject.ClassInfo, 0, "Collision", 0);
