...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoCollisionRect")]
	public partial class GeoCollisionRect : Fox.Geo.GeoCollisionPrimitiveBase
	{
		...
		static GeoCollisionRect()
		{
			if (Fox.Geo.GeoCollisionPrimitiveBase.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoCollisionRect", typeof(GeoCollisionRect), Fox.Geo.GeoCollisionPrimitiveBase.ClassInfo, 0, "Collision", 0);
