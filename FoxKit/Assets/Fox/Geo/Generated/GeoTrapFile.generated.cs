...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoTrapFile")]
	public partial class GeoTrapFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static GeoTrapFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoTrapFile", typeof(GeoTrapFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
