...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoCollisionFreeShape")]
	public partial class GeoCollisionFreeShape : Fox.Geo.CollisionObject
	{
		...
		static GeoCollisionFreeShape()
		{
			if (Fox.Geo.CollisionObject.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoCollisionFreeShape", typeof(GeoCollisionFreeShape), Fox.Geo.CollisionObject.ClassInfo, 0, "Collision", 0);
