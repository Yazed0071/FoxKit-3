...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoBoundingVolumeFile")]
	public partial class GeoBoundingVolumeFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static GeoBoundingVolumeFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoBoundingVolumeFile", typeof(GeoBoundingVolumeFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
