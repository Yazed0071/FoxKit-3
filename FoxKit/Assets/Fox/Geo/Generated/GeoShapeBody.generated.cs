...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoShapeBody")]
	public partial class GeoShapeBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static GeoShapeBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoShapeBody", typeof(GeoShapeBody), Fox.Core.TransformDataBody.ClassInfo, 0, "Geo", 0);
