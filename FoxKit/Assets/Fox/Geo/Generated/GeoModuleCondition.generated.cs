...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoModuleCondition")]
	public partial class GeoModuleCondition : Fox.Geo.GeoTrapCondition
	{
		...
		public override void RemovePropertyElement(string propertyName, int index)
		{
			...
			{
				case "checkFuncNames":
					this.checkFuncNames.RemoveAt(index);
					return;
				case "execFuncNames":
					this.execFuncNames.RemoveAt(index);
					return;
				case "checkCallbackDataElements":
					this.checkCallbackDataElements.RemoveAt(index);
					return;
				case "execCallbackDataElements":
					this.execCallbackDataElements.RemoveAt(index);
					return;
				default:
