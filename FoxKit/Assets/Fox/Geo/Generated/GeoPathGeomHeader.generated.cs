...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoPathGeomHeader")]
	public partial class GeoPathGeomHeader : Fox.Core.Entity
	{
		...
		static GeoPathGeomHeader()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoPathGeomHeader", typeof(GeoPathGeomHeader), Fox.Core.Entity.ClassInfo, 0, "Path", 0);
