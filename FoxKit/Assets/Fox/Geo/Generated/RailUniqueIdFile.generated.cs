...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/RailUniqueIdFile")]
	public partial class RailUniqueIdFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static RailUniqueIdFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("RailUniqueIdFile", typeof(RailUniqueIdFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
