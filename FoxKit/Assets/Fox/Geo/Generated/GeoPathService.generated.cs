...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoPathService")]
	public partial class GeoPathService : Fox.Core.Entity
	{
		// ClassInfos
		...
		static GeoPathService()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoPathService", typeof(GeoPathService), Fox.Core.Entity.ClassInfo, 0, null, 0);
