...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/RailFile")]
	public partial class RailFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static RailFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("RailFile", typeof(RailFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
