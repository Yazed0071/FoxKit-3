...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoModuleConditionBody")]
	public partial class GeoModuleConditionBody : Fox.Geo.GeoTrapConditionBody
	{
		...
		static GeoModuleConditionBody()
		{
			if (Fox.Geo.GeoTrapConditionBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoModuleConditionBody", typeof(GeoModuleConditionBody), Fox.Geo.GeoTrapConditionBody.ClassInfo, 0, "Trap", 0);
