...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/CollisionReferenceSet")]
	public partial class CollisionReferenceSet : Fox.Geo.CollisionObject
	{
		// ClassInfos
		...
		static CollisionReferenceSet()
		{
			if (Fox.Geo.CollisionObject.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("CollisionReferenceSet", typeof(CollisionReferenceSet), Fox.Geo.CollisionObject.ClassInfo, 0, "Collision", 0);
