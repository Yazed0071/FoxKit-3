...
namespace Fox.Geo
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Geo/GeoSearchObject")]
	public partial class GeoSearchObject : Fox.Core.Entity
	{
		// ClassInfos
		...
		static GeoSearchObject()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GeoSearchObject", typeof(GeoSearchObject), Fox.Core.Entity.ClassInfo, 0, null, 1);
