...
namespace Fox.Nt
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Nt/NtMemberSyncInstance")]
	public partial class NtMemberSyncInstance : Fox.Nt.SyncInstance
	{
		// ClassInfos
		...
		static NtMemberSyncInstance()
		{
			if (Fox.Nt.SyncInstance.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("NtMemberSyncInstance", typeof(NtMemberSyncInstance), Fox.Nt.SyncInstance.ClassInfo, 0, null, 0);
