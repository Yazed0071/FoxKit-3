...
namespace Fox.Nt
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Nt/SyncUniqueId")]
	public partial class SyncUniqueId : Fox.Core.Entity
	{
		// ClassInfos
		...
		static SyncUniqueId()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SyncUniqueId", typeof(SyncUniqueId), Fox.Core.Entity.ClassInfo, 0, null, 0);
