...
namespace Fox.Nt
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Nt/SyncInstance")]
	public partial class SyncInstance : Fox.Core.Entity
	{
		// ClassInfos
		...
		static SyncInstance()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SyncInstance", typeof(SyncInstance), Fox.Core.Entity.ClassInfo, 0, null, 0);
