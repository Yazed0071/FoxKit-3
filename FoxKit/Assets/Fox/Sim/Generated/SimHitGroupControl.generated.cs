...
namespace Fox.Sim
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Sim/SimHitGroupControl")]
	public partial class SimHitGroupControl : Fox.Sim.SimControlElement
	{
		...
		static SimHitGroupControl()
		{
			if (Fox.Sim.SimControlElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SimHitGroupControl", typeof(SimHitGroupControl), Fox.Sim.SimControlElement.ClassInfo, 56, "Sim", 0);
