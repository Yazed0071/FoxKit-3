...
namespace Fox.Sim
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Sim/SimControlElement")]
	public partial class SimControlElement : Fox.Core.DataElement
	{
		// Properties
		[field: UnityEngine.SerializeField]
		public CsSystem.Collections.Generic.List<string> bones { get; private set; } = new CsSystem.Collections.Generic.List<string>();
		...
		static SimControlElement()
		{
			if (Fox.Core.DataElement.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SimControlElement", typeof(SimControlElement), Fox.Core.DataElement.ClassInfo, 0, "Sim", 0);
			classInfo.AddStaticProperty(new Fox.Core.PropertyInfo("bones", Fox.Core.PropertyInfo.PropertyType.String, 56, 1, Fox.Core.PropertyInfo.ContainerType.DynamicArray, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, Fox.Core.PropertyInfo.PropertyExport.EditorAndGame, null, null, Fox.Core.PropertyInfo.PropertyStorage.Instance, Fox.Core.PropertyInfo.BackingType.Field));
