...
namespace Fox.Sim
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Sim/SimEngineParam")]
	public partial class SimEngineParam : Fox.Core.Entity
	{
		// ClassInfos
		...
		static SimEngineParam()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SimEngineParam", typeof(SimEngineParam), Fox.Core.Entity.ClassInfo, 0, "Sim", 0);
