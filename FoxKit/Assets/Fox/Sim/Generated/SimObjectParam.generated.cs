...
namespace Fox.Sim
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Sim/SimObjectParam")]
	public partial class SimObjectParam : Fox.Core.Entity
	{
		...
		static SimObjectParam()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SimObjectParam", typeof(SimObjectParam), Fox.Core.Entity.ClassInfo, 24, "Sim", 0);
