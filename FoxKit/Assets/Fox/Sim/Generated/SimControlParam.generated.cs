...
namespace Fox.Sim
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Sim/SimControlParam")]
	public partial class SimControlParam : Fox.Core.Entity
	{
		...
		static SimControlParam()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SimControlParam", typeof(SimControlParam), Fox.Core.Entity.ClassInfo, 0, "Sim", 0);
