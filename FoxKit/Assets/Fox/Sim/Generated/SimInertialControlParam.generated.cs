...
namespace Fox.Sim
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Sim/SimInertialControlParam")]
	public partial class SimInertialControlParam : Fox.Sim.SimControlParam
	{
		...
		static SimInertialControlParam()
		{
			if (Fox.Sim.SimControlParam.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SimInertialControlParam", typeof(SimInertialControlParam), Fox.Sim.SimControlParam.ClassInfo, 28, "Sim", 0);
		...
		public override Fox.Core.Value GetProperty(string propertyName)
		{
			...
			{
				case "coefficient":
					return new Fox.Core.Value(coefficient);
				default:
