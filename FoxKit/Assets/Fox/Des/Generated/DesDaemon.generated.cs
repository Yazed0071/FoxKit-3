...
namespace Fox.Des
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Des/DesDaemon")]
	public partial class DesDaemon : Fox.Core.Entity
	{
		...
		static DesDaemon()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("DesDaemon", typeof(DesDaemon), Fox.Core.Entity.ClassInfo, 0, "Des", 0);
