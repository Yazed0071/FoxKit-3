...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("GameCore/GameObjectDataBody")]
	public partial class GameObjectDataBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static GameObjectDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GameObjectDataBody", typeof(GameObjectDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
