...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("UiScene/UiCameraDataBody")]
	public partial class UiCameraDataBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static UiCameraDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("UiCameraDataBody", typeof(UiCameraDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
