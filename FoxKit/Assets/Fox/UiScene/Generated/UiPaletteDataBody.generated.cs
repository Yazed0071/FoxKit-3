...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("UiScene/UiPaletteDataBody")]
	public partial class UiPaletteDataBody : Fox.Core.DataBody
	{
		...
		static UiPaletteDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("UiPaletteDataBody", typeof(UiPaletteDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
