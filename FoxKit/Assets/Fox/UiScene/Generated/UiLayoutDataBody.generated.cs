...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("UiScene/UiLayoutDataBody")]
	public partial class UiLayoutDataBody : Fox.Core.TransformDataBody
	{
		...
		static UiLayoutDataBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("UiLayoutDataBody", typeof(UiLayoutDataBody), Fox.Core.TransformDataBody.ClassInfo, 0, "Ui", 0);
