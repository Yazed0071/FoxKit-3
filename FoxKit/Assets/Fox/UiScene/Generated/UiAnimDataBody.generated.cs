...
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("UiScene/UiAnimDataBody")]
	public partial class UiAnimDataBody : Fox.Core.DataBody
	{
		...
		static UiAnimDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("UiAnimDataBody", typeof(UiAnimDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
