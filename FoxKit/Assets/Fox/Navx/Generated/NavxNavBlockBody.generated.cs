...
namespace Fox.Navx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Navx/NavxNavBlockBody")]
	public partial class NavxNavBlockBody : Fox.Core.DataBody
	{
		...
		static NavxNavBlockBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("NavxNavBlockBody", typeof(NavxNavBlockBody), Fox.Core.DataBody.ClassInfo, 0, "Navx", 0);
