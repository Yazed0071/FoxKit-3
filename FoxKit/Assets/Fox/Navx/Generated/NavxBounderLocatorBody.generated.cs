...
namespace Fox.Navx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Navx/NavxBounderLocatorBody")]
	public partial class NavxBounderLocatorBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static NavxBounderLocatorBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("NavxBounderLocatorBody", typeof(NavxBounderLocatorBody), Fox.Core.TransformDataBody.ClassInfo, 0, "Navx", 0);
