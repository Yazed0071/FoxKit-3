...
namespace Fox.Navx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Navx/NavxKeepNavLocatorBody")]
	public partial class NavxKeepNavLocatorBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static NavxKeepNavLocatorBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("NavxKeepNavLocatorBody", typeof(NavxKeepNavLocatorBody), Fox.Core.TransformDataBody.ClassInfo, 0, "Navx", 0);
