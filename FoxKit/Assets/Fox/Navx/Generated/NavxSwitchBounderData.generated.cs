...
namespace Fox.Navx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Navx/NavxSwitchBounderData")]
	public partial class NavxSwitchBounderData : Fox.Navx.NavxBounderData
	{
		// ClassInfos
		...
		static NavxSwitchBounderData()
		{
			if (Fox.Navx.NavxBounderData.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("NavxSwitchBounderData", typeof(NavxSwitchBounderData), Fox.Navx.NavxBounderData.ClassInfo, 256, "Navx", 0);
