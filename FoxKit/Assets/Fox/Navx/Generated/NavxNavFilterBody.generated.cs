...
namespace Fox.Navx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Navx/NavxNavFilterBody")]
	public partial class NavxNavFilterBody : Fox.Core.TransformDataBody
	{
		...
		static NavxNavFilterBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("NavxNavFilterBody", typeof(NavxNavFilterBody), Fox.Core.TransformDataBody.ClassInfo, 0, "Navx", 0);
