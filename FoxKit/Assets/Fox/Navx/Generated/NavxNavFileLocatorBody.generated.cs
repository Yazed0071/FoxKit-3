...
namespace Fox.Navx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Navx/NavxNavFileLocatorBody")]
	public partial class NavxNavFileLocatorBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static NavxNavFileLocatorBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("NavxNavFileLocatorBody", typeof(NavxNavFileLocatorBody), Fox.Core.TransformDataBody.ClassInfo, 0, "Navx", 0);
