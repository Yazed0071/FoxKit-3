...
namespace Fox.Navx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Navx/NavxWorldGenerateParameterBody")]
	public partial class NavxWorldGenerateParameterBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static NavxWorldGenerateParameterBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("NavxWorldGenerateParameterBody", typeof(NavxWorldGenerateParameterBody), Fox.Core.TransformDataBody.ClassInfo, 0, "Navx", 0);
