...
namespace Fox.Navx
{
	...
	public partial class NavxFillNavVolumeBody : Fox.Core.TransformDataBody
	{
		...
		static NavxFillNavVolumeBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("NavxFillNavVolumeBody", typeof(NavxFillNavVolumeBody), Fox.Core.TransformDataBody.ClassInfo, 0, "Navx", 0);
