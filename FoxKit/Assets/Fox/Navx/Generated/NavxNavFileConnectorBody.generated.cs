...
namespace Fox.Navx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Navx/NavxNavFileConnectorBody")]
	public partial class NavxNavFileConnectorBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static NavxNavFileConnectorBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("NavxNavFileConnectorBody", typeof(NavxNavFileConnectorBody), Fox.Core.TransformDataBody.ClassInfo, 0, "Navx", 0);
