...
namespace Fox.Ui
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Ui/UiFontGroupDataBody")]
	public partial class UiFontGroupDataBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static UiFontGroupDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("UiFontGroupDataBody", typeof(UiFontGroupDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
