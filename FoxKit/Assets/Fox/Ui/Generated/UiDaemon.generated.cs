...
namespace Fox.Ui
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Ui/UiDaemon")]
	public partial class UiDaemon : Fox.Core.Entity
	{
		...
		static UiDaemon()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("UiDaemon", typeof(UiDaemon), Fox.Core.Entity.ClassInfo, 0, null, 0);
