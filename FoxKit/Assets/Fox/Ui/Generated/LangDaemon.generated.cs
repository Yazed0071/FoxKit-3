...
namespace Fox.Ui
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Ui/LangDaemon")]
	public partial class LangDaemon : Fox.Core.Entity
	{
		...
		static LangDaemon()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("LangDaemon", typeof(LangDaemon), Fox.Core.Entity.ClassInfo, 0, null, 0);
