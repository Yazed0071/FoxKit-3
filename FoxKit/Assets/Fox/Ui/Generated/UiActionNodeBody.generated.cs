...
namespace Fox.Ui
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Ui/UiActionNodeBody")]
	public partial class UiActionNodeBody : Fox.Ui.UiNodeDataBody
	{
		// ClassInfos
		...
		static UiActionNodeBody()
		{
			if (Fox.Ui.UiNodeDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("UiActionNodeBody", typeof(UiActionNodeBody), Fox.Ui.UiNodeDataBody.ClassInfo, 0, null, 0);
