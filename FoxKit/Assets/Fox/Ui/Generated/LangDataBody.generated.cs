...
namespace Fox.Ui
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Ui/LangDataBody")]
	public partial class LangDataBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static LangDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("LangDataBody", typeof(LangDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
