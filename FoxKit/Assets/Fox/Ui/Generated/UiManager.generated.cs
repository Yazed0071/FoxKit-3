...
namespace Fox.Ui
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Ui/UiManager")]
	public partial class UiManager : Fox.Core.Entity
	{
		// ClassInfos
		...
		static UiManager()
		{
			if (Fox.Core.Entity.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("UiManager", typeof(UiManager), Fox.Core.Entity.ClassInfo, 0, null, 0);
