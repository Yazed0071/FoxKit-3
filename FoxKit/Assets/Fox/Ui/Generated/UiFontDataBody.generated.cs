...
namespace Fox.Ui
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Ui/UiFontDataBody")]
	public partial class UiFontDataBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static UiFontDataBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("UiFontDataBody", typeof(UiFontDataBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
