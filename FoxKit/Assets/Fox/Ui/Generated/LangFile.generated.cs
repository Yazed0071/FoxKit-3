...
namespace Fox.Ui
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Ui/LangFile")]
	public partial class LangFile : Fox.Core.RawFile
	{
		...
		static LangFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("LangFile", typeof(LangFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
