...
namespace Fox.Ui
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Ui/TexListFile")]
	public partial class TexListFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static TexListFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("TexListFile", typeof(TexListFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
