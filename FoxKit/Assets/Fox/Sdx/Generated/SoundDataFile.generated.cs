...
namespace Fox.Sdx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Sdx/SoundDataFile")]
	public partial class SoundDataFile : Fox.Core.DataSetFile2
	{
		// ClassInfos
		...
		{
			if (Fox.Core.DataSetFile2.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SoundDataFile", typeof(SoundDataFile), Fox.Core.DataSetFile2.ClassInfo, 0, null, 0);
