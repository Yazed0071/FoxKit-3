...
namespace Fox.Sdx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Sdx/SoundSourceBody")]
	public partial class SoundSourceBody : Fox.Core.TransformDataBody
	{
		// ClassInfos
		...
		static SoundSourceBody()
		{
			if (Fox.Core.TransformDataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SoundSourceBody", typeof(SoundSourceBody), Fox.Core.TransformDataBody.ClassInfo, 0, null, 0);
