...
namespace Fox.Sdx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Sdx/SoundAreaMemberBody")]
	public partial class SoundAreaMemberBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static SoundAreaMemberBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SoundAreaMemberBody", typeof(SoundAreaMemberBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
