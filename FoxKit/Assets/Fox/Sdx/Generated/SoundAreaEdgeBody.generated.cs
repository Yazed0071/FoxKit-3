...
namespace Fox.Sdx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Sdx/SoundAreaEdgeBody")]
	public partial class SoundAreaEdgeBody : Fox.Core.DataBody
	{
		...
		static SoundAreaEdgeBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SoundAreaEdgeBody", typeof(SoundAreaEdgeBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
