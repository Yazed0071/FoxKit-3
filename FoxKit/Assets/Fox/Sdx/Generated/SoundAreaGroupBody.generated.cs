...
namespace Fox.Sdx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Sdx/SoundAreaGroupBody")]
	public partial class SoundAreaGroupBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static SoundAreaGroupBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SoundAreaGroupBody", typeof(SoundAreaGroupBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
