...
namespace Fox.Sdx
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Sdx/SoundAreaGlobalBody")]
	public partial class SoundAreaGlobalBody : Fox.Core.DataBody
	{
		// ClassInfos
		...
		static SoundAreaGlobalBody()
		{
			if (Fox.Core.DataBody.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SoundAreaGlobalBody", typeof(SoundAreaGlobalBody), Fox.Core.DataBody.ClassInfo, 0, null, 0);
