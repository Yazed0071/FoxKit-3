...
namespace Fox.Anim
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Anim/SandFile")]
	public partial class SandFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static SandFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("SandFile", typeof(SandFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
