...
namespace Fox.Anim
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Anim/GaniBaseFile")]
	public partial class GaniBaseFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static GaniBaseFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("GaniBaseFile", typeof(GaniBaseFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
