...
namespace Fox.Anim
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Anim/RigFile")]
	public partial class RigFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static RigFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("RigFile", typeof(RigFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
