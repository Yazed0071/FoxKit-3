...
namespace Fox.Anim
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Anim/EvbFile")]
	public partial class EvbFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static EvbFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("EvbFile", typeof(EvbFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
