...
namespace Fox.Anim
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Anim/CaarFile")]
	public partial class CaarFile : Fox.Core.RawFile
	{
		// ClassInfos
		...
		static CaarFile()
		{
			if (Fox.Core.RawFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("CaarFile", typeof(CaarFile), Fox.Core.RawFile.ClassInfo, 0, null, 0);
