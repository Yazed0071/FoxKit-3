...
namespace Fox.Anim
{
	[UnityEditor.InitializeOnLoad, UnityEngine.AddComponentMenu("Anim/MtFile")]
	public partial class MtFile : Fox.Anim.GaniBaseFile
	{
		// ClassInfos
		...
		static MtFile()
		{
			if (Fox.Anim.GaniBaseFile.ClassInfoInitialized)
				classInfo = new Fox.Core.EntityInfo("MtFile", typeof(MtFile), Fox.Anim.GaniBaseFile.ClassInfo, 0, null, 0);
